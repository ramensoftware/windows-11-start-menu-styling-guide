...
```json
{
  ...
  "controlStyles[15].styles[0]": "Background@Normal:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"0\" Opacity=\"0.15\"/>",
  ...
  "controlStyles[12].styles[2]": "Background@Normal:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"0\" Opacity=\"0.15\"/>",
  ...
  "controlStyles[22].target": "TextBlock",
  "controlStyles[22].styles[0]": "Foreground=#E1E1E1"
}
```
</details>
