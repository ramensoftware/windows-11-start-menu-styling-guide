...

{
  ...
  "controlStyles[21].styles[0]": "Background@PointerOver:=$Background",
  "controlStyles[21].styles[1]": "Background@Pressed:=$Background",
  "controlStyles[21].styles[2]": "Background@Selected:=$Background",
  ...
  "controlStyles[41].styles[1]": "Background:=$Background",
  ...
  "styleConstants[4]": "ClockBG=<WindhawkBlur BlurAmount=\"15\" TintColor=\"{ThemeResource SystemAccentColorLight2}\" TintOpacity=\"0.3\" />",
