...
```json
  {
    ...
    "controlStyles[1].styles[1]": "RenderTransform:=<TransformGroup><TranslateTransform X=\"-45\" Y=\"-16\" /><ScaleTransform ScaleX=\"3.3\" ScaleY=\"6\" /></TransformGroup>",
    "controlStyles[1].styles[2]": "FontFamily=Morganite SemiBold",
    "controlStyles[1].styles[3]": "Foreground:=$Glass",
    ...
    "controlStyles[2].styles[3]": "Foreground:=$Glass",
    ...
    "controlStyles[39].styles[0]": "Background:=$Glass",
