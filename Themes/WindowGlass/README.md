...
```json
{
  ...
  "controlStyles[20].target": "Windows.UI.Xaml.Controls.Border#RootGridDropShadow",
  "controlStyles[20].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[21].target": "Windows.UI.Xaml.Controls.Border#RightCompanionDropShadow",
  "controlStyles[21].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[21].styles[1]": "Visibility=1",
  "controlStyles[22].target": "Windows.UI.Xaml.Controls.Grid#DroppedFlickerWorkaroundWrapper > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[22].styles[0]": "Background@PointerOver:=$Glass",
  "controlStyles[22].styles[1]": "Background@Pressed:=$Glass",
  "controlStyles[22].styles[2]": "Background@Selected:=$Glass",
  "controlStyles[23].target": "Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[23].styles[0]": "CornerRadius=10",
  "controlStyles[24].target": "Windows.UI.Xaml.Controls.Grid#ContentBorder",
  "controlStyles[24].styles[0]": "CornerRadius=10",
  "controlStyles[25].target": "Windows.UI.Xaml.Controls.Border#LayerBorder",
  "controlStyles[25].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[26].target": "Windows.UI.Xaml.Controls.Grid#OuterBorderGrid",
  "controlStyles[26].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[27].target": "Windows.UI.Xaml.Controls.Grid#MainMenu",
  "controlStyles[27].styles[0]": "",
  "controlStyles[28].target": "Windows.UI.Xaml.PopupRoot",
  "controlStyles[28].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[29].target": "Windows.UI.Xaml.Controls.ContentPresenter#ZoomedInPresenter > Windows.UI.Xaml.Controls.GridView#AllAppsGrid > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.ScrollViewer#ScrollViewer > Windows.UI.Xaml.Controls.Border#Root > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.ScrollContentPresenter#ScrollContentPresenter > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.ItemsWrapGrid",
  "controlStyles[29].styles[0]": "MaximumRowsOrColumns=2",
  "controlStyles[30].target": "Windows.UI.Xaml.Controls.Grid#RightCompanionContainerGrid",
  "controlStyles[30].styles[0]": "Margin=-420,142,0,50",
  "controlStyles[30].styles[1]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-90\" />",
  "controlStyles[30].styles[2]": "Width=300",
  "controlStyles[30].styles[3]": "Height=Auto",
  "controlStyles[30].styles[4]": "MaxHeight:=700",
  "controlStyles[30].styles[5]": "MinHeight:=300",
  "controlStyles[31].target": "StartMenu.PinnedList#StartMenuPinnedList",
  "controlStyles[31].styles[0]": "Visibility=0",
  "controlStyles[31].styles[1]": "Margin=30,0,25,0",
  "controlStyles[31].styles[2]": "RenderTransform:=<TranslateTransform X=\"-0\" Y=\"0\" />",
  "controlStyles[31].styles[3]": "Height=Auto",
  "controlStyles[31].styles[4]": "MinHeight:=200",
  "controlStyles[31].styles[5]": "MaxHeight:=1000",
  "controlStyles[32].target": "Windows.UI.Xaml.Controls.TextBlock#PinnedListHeaderText",
  "controlStyles[32].styles[0]": "Visibility=0",
  "controlStyles[32].styles[1]": "Margin=0",
  "controlStyles[32].styles[2]": "RenderTransform:=<TranslateTransform X=\"60\" Y=\"-10\" />",
  "controlStyles[33].target": "Microsoft.UI.Xaml.Controls.DropDownButton#ViewSelectionButton",
  "controlStyles[33].styles[0]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"0\" />",
  "controlStyles[34].target": "Windows.UI.Xaml.Controls.Grid#NavPanePlaceholder",
  "controlStyles[34].styles[0]": "Width=Auto",
  "controlStyles[34].styles[1]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"0\" />",
  "controlStyles[34].styles[2]": "Background:=$ElementBG",
  "controlStyles[34].styles[3]": "BorderBrush:=$ElementBorderBrush",
  "controlStyles[34].styles[4]": "CornerRadius=$ElementCornerRadius",
  "controlStyles[34].styles[5]": "BorderThickness=$ElementBorderThickness",
  "controlStyles[34].styles[6]": "Height=70",
  "controlStyles[34].styles[7]": "Padding=5",
  "controlStyles[34].styles[8]": "Margin=420,-100,0,0",
  "controlStyles[34].styles[9]": "MaxWidth:=300",
  "controlStyles[34].styles[10]": "MinWidth:=200",
  "controlStyles[35].target": "Windows.UI.Xaml.Controls.Primitives.ScrollBar#VerticalScrollBar",
  "controlStyles[35].styles[0]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"0\" />",
  "controlStyles[36].target": "StartMenu.PinnedList#StartMenuPinnedList > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.GridView#PinnedList > Windows.UI.Xaml.Controls.Border",
  ...
  "controlStyles[36].styles[3]": "BorderThickness=$ElementBorderThickness",
  "controlStyles[36].styles[4]": "Padding:=20,10,0,10",
  "controlStyles[37].target": "Windows.UI.Xaml.Controls.Grid#TopLevelHeader > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Button",
  "controlStyles[37].styles[0]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-5\" />",
  "controlStyles[38].target": "StartMenu.PinnedListTile > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.Grid#DisplayNameAndDownloadIconContainer > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[38].styles[0]": "Visibility=0",
  "controlStyles[39].target": "StartMenu.StartHome > Windows.UI.Xaml.Controls.Grid#PageRoot",
  "controlStyles[39].styles[0]": "Margin=190,40,190,0",
  "controlStyles[39].styles[1]": "RenderTransform:=<TranslateTransform X=\"-190\" Y=\"0\" />",
  "controlStyles[39].styles[2]": "Padding=0,0,0-20",
  "controlStyles[40].target": "StartMenu.StartMenuCompanion#RightCompanion > Windows.UI.Xaml.Controls.Grid#CompanionRoot > Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  ...
  "controlStyles[41].target": "Windows.UI.Xaml.Controls.Grid#TopLevelHeader > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Button",
  ...
  "controlStyles[42].styles[0]": "BorderBrush:=$BorderBrush",
  "controlStyles[42].styles[1]": "Background:=$Glass",
  "controlStyles[42].styles[2]": "CornerRadius=15",
  "controlStyles[42].styles[3]": "BorderThickness=$BorderThickness",
  "controlStyles[43].target": "Windows.UI.Xaml.Controls.ToolTip > Windows.UI.Xaml.Controls.ContentPresenter#LayoutRoot",
  ...
  "controlStyles[44].target": "Windows.UI.Xaml.Controls.Button#AddButton",
  ...
  "controlStyles[45].target": "StartMenu.StartBlendedFlexFrame",
  "controlStyles[45].styles[0]": "Width=Auto",
  "controlStyles[45].styles[1]": "MaxWidth:=860",
  "controlStyles[45].styles[2]": "MinWidth:=500",
  ...
  "controlStyles[48].styles[3]": "Margin=0,0,-10,0",
  ...
  "controlStyles[50].styles[0]": "MaxHeight:=420",
  "controlStyles[50].styles[1]": "MaxWidth:=420",
  ...
  "controlStyles[51].styles[0]": "Width=400",
  "controlStyles[51].styles[1]": "Height=400",
...
```json
{
  ...
  "controlStyles[21].styles[0]": "CornerRadius=$CornerRadius",
  "controlStyles[22].target": "Windows.UI.Xaml.Controls.Border#RootGridDropShadow",
  ...
  "controlStyles[24].styles[0]": "Background@PointerOver:=$Glass",
  "controlStyles[24].styles[1]": "Background@Pressed:=$Glass",
  "controlStyles[24].styles[2]": "Background@Selected:=$Glass",
  ...
  "controlStyles[29].styles[0]": "// Unused",
  ...
  "controlStyles[31].styles[1]": "Margin=5,-95,5,0",
  "controlStyles[31].styles[2]": "Width=Auto",
  "controlStyles[31].styles[3]": "MinWidth:=100",
  "controlStyles[31].styles[4]": "MaxWidth:=350",
  ...
  "controlStyles[33].styles[1]": "Margin=0,0,0,65",
  ...
  "controlStyles[34].styles[1]": "Margin=0,10,0,0",
  ...
  "controlStyles[36].styles[8]": "Margin=0,-100,0,0",
  "controlStyles[36].styles[9]": "MaxWidth:=300",
  "controlStyles[36].styles[10]": "MinWidth=200",
  "controlStyles[37].target": "Windows.UI.Xaml.Controls.Primitives.ScrollBar#VerticalScrollBar",
  "controlStyles[37].styles[0]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"0\" />",
  "controlStyles[38].target": "StartMenu.PinnedList#StartMenuPinnedList > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.GridView#PinnedList > Windows.UI.Xaml.Controls.Border",
  "controlStyles[38].styles[0]": "Background:=$ElementBG",
  "controlStyles[38].styles[1]": "BorderBrush:=$ElementBorderBrush",
  "controlStyles[38].styles[2]": "CornerRadius=$CornerRadius",
  "controlStyles[38].styles[3]": "BorderThickness=$ElementBorderThickness",
  "controlStyles[38].styles[4]": "Padding:=20,10,0,10",
  "controlStyles[39].target": "Windows.UI.Xaml.Controls.Grid#AllListHeading",
  "controlStyles[39].styles[0]": "RenderTransform:=<TranslateTransform X=\"0\" Y=\"-70\" />",
  "controlStyles[40].target": "StartMenu.PinnedListTile > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.Grid#DisplayNameAndDownloadIconContainer > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[40].styles[0]": "Visibility=0",
  "controlStyles[41].target": "StartMenu.StartHome",
  "controlStyles[41].styles[0]": "Margin=0,0,0,60",
  "controlStyles[41].styles[1]": "Padding=0",
  "controlStyles[42].target": "StartMenu.StartMenuCompanion#RightCompanion > Windows.UI.Xaml.Controls.Grid#CompanionRoot > Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  ...
  "controlStyles[43].target": "Windows.UI.Xaml.Controls.Grid#TopLevelHeader > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Button",
  "controlStyles[43].styles[0]": "Visibility=1",
  "controlStyles[44].target": "Windows.UI.Xaml.Controls.MenuFlyoutPresenter > Windows.UI.Xaml.Controls.Border",
  "controlStyles[44].styles[0]": "BorderBrush:=$BorderBrush",
  "controlStyles[44].styles[1]": "Background:=$Glass",
  "controlStyles[44].styles[2]": "CornerRadius=15",
  "controlStyles[44].styles[3]": "BorderThickness=$BorderThickness",
  "controlStyles[45].target": "Windows.UI.Xaml.Controls.ToolTip > Windows.UI.Xaml.Controls.ContentPresenter#LayoutRoot",
  ...
  "controlStyles[46].target": "Windows.UI.Xaml.Controls.Button#AddButton",
  "controlStyles[46].styles[0]": "Background:=$Glass",
  ...
  "controlStyles[49].styles[3]": "Margin=10,40,-20,-40",
  ...
  "controlStyles[54].target": "StartMenu.StartBlendedFlexFrame",
  "controlStyles[54].styles[0]": "Width=480",
  "controlStyles[55].target": "Grid#TopLevelSuggestionsListHeader",
  "controlStyles[55].styles[0]": "Margin=-5,-40,5,0",
  "controlStyles[56].target": "Windows.UI.Xaml.Controls.GridView#RecommendedList",
  "controlStyles[56].styles[0]": "Margin=-5,-60,5,60",
  "controlStyles[57].target": "Button#ShowMoreSuggestionsButton",
  "controlStyles[57].styles[0]": "Margin=-55,-64,55,64",
