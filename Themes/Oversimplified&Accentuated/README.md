...
```json
{
  ...
  "controlStyles[20].target": "ItemsControl#LogosItemsControl",
  "controlStyles[20].styles[0]": "Height=50",
  "controlStyles[20].styles[1]": "Width=50",
  "controlStyles[20].styles[2]": "//Target= Start Menu > Folder Thumbnail-Preview Container",
  
  "controlStyles[21].target": "ItemsControl#LogosItemsControl > ItemsPresenter > ItemsWrapGrid > ContentPresenter > Windows.UI.Xaml.Controls.Grid",
  "controlStyles[21].styles[0]": "Height=22",
  "controlStyles[21].styles[1]": "Width=22",
  "controlStyles[21].styles[2]": "//Target= Start Menu > Folder Thumbnail-Preview Icons",
  
  "controlStyles[22].target": "Grid#Root > Border",
  ...
  "controlStyles[22].styles[3]": "//Target= Start Menu > Folder > Body",
  
  "controlStyles[23].target": "TextBlock#TruncationTextBlock",
  "controlStyles[23].styles[0]": "FontSize=30",
  "controlStyles[23].styles[1]": "//Target= Start Menu > Folder > Title Text",
  
  "controlStyles[24].target": "TextBlock#DisplayName",
  "controlStyles[24].styles[0]": "Visibility=Collapsed",
  "controlStyles[24].styles[1]": "//Target= Start Menu > Name of Pinned Apps & Folders",
  
  "controlStyles[25].target": "Grid#SuggestionsParentContainer",
  "controlStyles[25].styles[0]": "Visibility=Collapsed",
  "controlStyles[25].styles[1]": "//Target= Start Menu > Suggestions Section",
  
  "controlStyles[26].target": "Grid#TopLevelSuggestionsListHeader",
  "controlStyles[26].styles[0]": "Visibility=Collapsed",
  "controlStyles[26].styles[1]": "//Target= Start Menu > Suggestions Text \"Recommended\"",
  
  "controlStyles[27].target": "Grid#ShowMoreSuggestions",
  "controlStyles[27].styles[0]": "Visibility=Collapsed",
  "controlStyles[27].styles[1]": "//Target= Start Menu > Show More Suggestions Button",
  
  "controlStyles[28].target": "Grid#TopLevelSuggestionsContainer",
  "controlStyles[28].styles[0]": "Visibility=Collapsed",
  "controlStyles[28].styles[1]": "//Target= Start Menu > Suggestions Entries",
  
  "controlStyles[29].target": "StartDocked.NavigationPaneButton#PowerButton > Grid",
  "controlStyles[29].styles[0]": "BorderBrush:=$Reveal",
  "controlStyles[29].styles[1]": "BorderThickness=2",
  "controlStyles[29].styles[2]": "CornerRadius=12",
  "controlStyles[29].styles[3]": "//Target= Start Menu > Power Button",
  
  "controlStyles[30].target": "StartDocked.NavigationPaneButton#PowerButton > Grid > ContentPresenter > Grid > FontIcon",
  "controlStyles[30].styles[0]": "Foreground:=$SolidAccent",
  "controlStyles[30].styles[1]": "//Target= Start Menu > Power Button icon",
  
  "controlStyles[31].target": "FontIcon#WindowsUpdatePendingReminder",
  "controlStyles[31].styles[0]": "Foreground:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" Opacity=\"1\" />",
  "controlStyles[31].styles[1]": "//Target= Start Menu > Power Button > Update Reminder (Default:#ff9900)",
  
  "controlStyles[32].target": "FontIcon#IconOverlay",
  "controlStyles[32].styles[0]": "Foreground:=$SolidAccent",
  "controlStyles[32].styles[1]": "//Target= Start Menu > Power Button > Power Menu > Update Reminder (Default:#ff9900)",
  
  "controlStyles[33].target": "Grid#AccountBadgePlaceholder > StartDocked.IconBadgeView > Grid#IconBadgeRoot > Grid > Windows.UI.Xaml.Shapes.Ellipse",
  "controlStyles[33].styles[0]": "Fill:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" Opacity=\"1\" />",
  "controlStyles[33].styles[1]": "//Target= Start Menu > Account Button > Account Notification Reminder",
  
  "controlStyles[34].target": "Border#BackgroundBorder",
  "controlStyles[34].styles[0]": "CornerRadius=12",
  "controlStyles[34].styles[1]": "//Target= Start Menu > Hover-Over Box For Buttons (Power Button, Libraries & User Button)",
  
  "controlStyles[35].target": "Button#ShowAllAppsButton > ContentPresenter",
  "controlStyles[35].styles[0]": "Background:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.5\" />",
  "controlStyles[35].styles[1]": "BorderBrush=Transparent",
  "controlStyles[35].styles[2]": "Height=25",
  "controlStyles[35].styles[3]": "//Target= Start Menu > \"All >\" Button",
  
  "controlStyles[36].target": "Button#CloseAllAppsButton > ContentPresenter",
  "controlStyles[36].styles[0]": "Background:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.5\" />",
  "controlStyles[36].styles[1]": "BorderBrush=Transparent",
  "controlStyles[36].styles[2]": "Height=25",
  "controlStyles[36].styles[3]": "//Target= Start Menu > All Apps Page > \"< Back\" Button",
  
  "controlStyles[37].target": "Button > ContentPresenter > StackPanel > TextBlock",
  "controlStyles[37].styles[0]": "Visibility=Collapsed",
  "controlStyles[37].styles[1]": "//Target= Start Menu > \"All >\" & \"< Back\" Buttons Text",
  
  "controlStyles[38].target": "StackPanel > FontIcon > Grid > TextBlock",
  "controlStyles[38].styles[0]": "FontSize=14 //(Default=10)",
  "controlStyles[38].styles[1]": "//Target= Start Menu > \"All >\" & \"< Back\" Buttons Arrows Text",
  
  "controlStyles[39].target": "Windows.UI.Xaml.Controls.TextBlock#AllAppsHeading",
  "controlStyles[39].styles[0]": "Visibility=Collapsed",
  "controlStyles[39].styles[1]": "//Target= Start Menu > All Apps Page > \"All\" Text",
  
  "controlStyles[40].target": "StartDocked.AllAppsZoomListViewItem > Grid#ContentBorder@DisabledStates > Border#BorderBackground",
  "controlStyles[40].styles[0]": "BorderBrush@Enabled:=$Reveal",
  "controlStyles[40].styles[1]": "//Target= Start Menu > All Apps Page > Alphabet Zoomed-Out Buttons",
  
  "controlStyles[41].target": "Border#Border",
  "controlStyles[41].styles[0]": "BorderBrush:=$Reveal",
  "controlStyles[41].styles[1]": "BorderThickness=2",
  "controlStyles[41].styles[2]": "CornerRadius=12",
  "controlStyles[41].styles[3]": "//Target= Start Menu > All Apps Page > Hover-Over Box for Alphabet",
  
  "controlStyles[42].target": "Border#BorderBackground",
  "controlStyles[42].styles[0]": "CornerRadius=12",
  "controlStyles[42].styles[1]": "//Target= Start Menu > All Apps Page > Hover-Over Box for Apps & Folders",
  
  "controlStyles[43].target": "Border#AppBorder",
  "controlStyles[43].styles[0]": "Background:=$Alt",
  "controlStyles[43].styles[1]": "BorderBrush=Transparent",
  "controlStyles[43].styles[2]": "CornerRadius=20",
  "controlStyles[43].styles[3]": "//Target= Search Menu's Body",
  
  "controlStyles[44].target": "Border#LayerBorder",
  "controlStyles[44].styles[0]": "Visibility=Collapsed",
  "controlStyles[44].styles[1]": "//Target= Search Menu > Acrylic Overlay Layer for Search Menu",
  
  "controlStyles[45].target": "Border#dropshadow",
  "controlStyles[45].styles[0]": "Visibility=Collapsed",
  "controlStyles[45].styles[1]": "//Target= Search Menu > Drop Shadow",
  
  "controlStyles[46].target": "Border#TaskbarSearchBackground",
  "controlStyles[46].styles[0]": "Background=Transparent",
  "controlStyles[46].styles[1]": "BorderBrush=Transparent",
  "controlStyles[46].styles[2]": "//Target= Search Menu > Search Box Overlay",
  
  "controlStyles[47].target": "Cortana.UI.Views.RichSearchBoxControl#SearchBoxControl > Grid#RootGrid",
  "controlStyles[47].styles[0]": "BorderBrush:=$Reveal",
  "controlStyles[47].styles[1]": "BorderThickness=2",
  "controlStyles[47].styles[2]": "CornerRadius=20",
  "controlStyles[47].styles[3]": "//Target= Search Menu > Search Box",
  
  "controlStyles[48].target": "Microsoft.UI.Xaml.Controls.AnimatedIcon#SearchIconPlayer",
  "controlStyles[48].styles[0]": "Width=20",
  "controlStyles[48].styles[1]": "//Target= Search Menu > Search icon",
