...
```json
{
  ...
  "controlStyles[1].styles[0]": "MinHeight=504",
  "controlStyles[1].styles[1]": "MaxHeight=504",
  ...
  "controlStyles[8].styles[1]": "RenderTransform:=<TranslateTransform X=\"345\" Y=\"750\"/>",
  "controlStyles[8].styles[2]": "VerticalAlignment=Top",
  ...
  "controlStyles[11].styles[0]": "Margin=-390,48,390,-48",
  ...
  "controlStyles[17].styles[0]": "RenderTransform:=<TranslateTransform X=\"360\" Y=\"700\"/>",
  ...
  "controlStyles[21].styles[1]": "Margin=0,50,0,0",
