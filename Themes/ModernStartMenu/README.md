...
```json
{
    ...
    "controlStyles[0].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\"0.16\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumColor}\" />",
    ...
    "controlStyles[2].styles[2]": "Width=260",
    ...
    "controlStyles[121].styles[1]": "Margin=9,0,0,4",
