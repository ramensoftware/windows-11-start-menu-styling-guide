...
```json
{
    ...
    "controlStyles[55].target": "Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter > Grid > ProgressBar",
    "controlStyles[55].styles[0]": "Width=175",
    "controlStyles[55].styles[1]": "CornerRadius=0.5",
    "controlStyles[56].target": "StartUI.StartSizingFramePanel",
    "controlStyles[56].styles[0]": "Margin=13",
    ...
    "controlStyles[57].target": "Border#LogoBackgroundPlate",
    "controlStyles[57].styles[0]": "Margin=12,6,0,6",
    "controlStyles[58].target": "MenuFlyoutItem > Grid@CommonStates",
    "controlStyles[58].styles[0]": "Padding=12,0,0,0",
    "controlStyles[59].target": "ToggleMenuFlyoutItem > Grid@CommonStates",
    ...
    "controlStyles[60].target": "TextBlock#ShutdownConfirmationTextBlock",
    "controlStyles[61].target": "Button#ShutdownConfirmationButton",
    "controlStyles[61].styles[0]": "Margin=0,17,0,0",
    "controlStyles[61].styles[1]": "MinWidth=150",
    "controlStyles[61].styles[2]": "Height=32",
    "controlStyles[61].styles[3]": "CornerRadius=4",
    "controlStyles[62].target": "Button#ShutdownConfirmationButton > ContentPresenter@CommonStates",
    "controlStyles[62].styles[0]": "Background@Normal:=$buttonNormal",
    "controlStyles[62].styles[1]": "Background@PointerOver:=$buttonPointerOver",
    "controlStyles[62].styles[2]": "Background@Pressed:=$buttonPressed",
    "controlStyles[62].styles[3]": "BorderThickness=1",
    "controlStyles[62].styles[4]": "BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[3].styles[2]": "Margin=0,0,-16,2",
    "controlStyles[63].target": "Border#NameTextBoxHost > TextBox > Grid > Button#DeleteButton > Grid@CommonStates",
    "controlStyles[63].styles[0]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[63].styles[1]": "CornerRadius=4",
    "controlStyles[63].styles[2]": "Height=20",
    "controlStyles[63].styles[3]": "Width=28",
    "controlStyles[63].styles[4]": "Margin=-12,0,0,0",
    "controlStyles[64].target": "Border#NameTextBoxHost > TextBox",
    "controlStyles[64].styles[0]": "FontWeight=Semibold",
    ...
    "controlStyles[51].styles[1]": "Background@Normal:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"1\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[51].styles[2]": "BorderThickness=0,1.5,0,0",
    "controlStyles[55].styles[2]": "Margin=9,0,0,0",
    "controlStyles[65].target": "Grid#InnerRoot",
    "controlStyles[65].styles[0]": "Height=46",
    "controlStyles[38].styles[2]": "Margin=1,0,0,2",
    "controlStyles[39].styles[1]": "Margin=8,-1,0,1",
    "controlStyles[66].target": "TextBlock#SignedInStatus",
    "controlStyles[66].styles[0]": "FontSize=12",
    "controlStyles[66].styles[1]": "Margin=8,-1,0,3",
    "controlStyles[67].target": "MenuFlyoutSeparator > Rectangle",
    "controlStyles[67].styles[0]": "Fill:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\"/>",
    "controlStyles[68].target": "TextBlock#ExpandCollapseButtonText",
    "controlStyles[68].styles[0]": "Margin=20,0,0,0",
    "controlStyles[67].styles[1]": "Margin=0,4,0,3",
    "controlStyles[69].target": "Rectangle",
    "controlStyles[69].styles[0]": "RadiusX=4",
    "controlStyles[69].styles[1]": "RadiusY=4",
    "controlStyles[48].styles[0]": "Background@Selected:=$buttonNormal",
    "controlStyles[70].target": "Grid#RootPanel@CommonStates > Rectangle",
    "controlStyles[70].styles[0]": "Fill@Selected:=$accentButtonNormal",
    "controlStyles[70].styles[1]": "Height=16",
    "controlStyles[70].styles[2]": "Width=3",
    "controlStyles[70].styles[3]": "RadiusX=2",
    "controlStyles[8].styles[2]": "BorderBrush:=$borderBrush",
    "controlStyles[8].styles[3]": "BorderThickness=1,1,0,1",
    "controlStyles[71].target": "StartUI.NavigationPaneGrid > StartUI.UserTileView > StartUI.NavigationPaneButton#UserTileButton ",
    "controlStyles[71].styles[0]": "Margin=6",
    "controlStyles[71].styles[1]": "Height=36",
    "controlStyles[72].target": "StartUI.NavigationPaneGrid > StartUI.PowerOptionsView > StartUI.NavigationPaneButton#PowerButton ",
    "controlStyles[72].styles[0]": "Margin=6",
    "controlStyles[72].styles[1]": "Height=36",
    "controlStyles[73].target": "StartUI.ViewSelectionListViewItem",
    "controlStyles[73].styles[0]": "Margin=6",
    "controlStyles[73].styles[1]": "Height=36",
    "controlStyles[74].target": "StartUI.AppListViewItem",
    "controlStyles[74].styles[0]": "Margin=6",
    "controlStyles[74].styles[1]": "Height=36",
    "controlStyles[75].target": "StartUI.NavigationPaneItemPanel > FontIcon",
    "controlStyles[75].styles[0]": "Margin=-12,0,0,0",
    "controlStyles[76].target": "StartUI.NavigationPaneItemPanel > Grid > FontIcon",
    "controlStyles[76].styles[0]": "Margin=-12,0,0,0",
    "controlStyles[77].target": "StartUI.NavigationPaneButton#UserTileButton > ContentPresenter > StartUI.NavigationPaneItemPanel > Grid",
    ...
    "controlStyles[78].target": "StartUI.NavigationPaneItemPanel > TextBlock",
    "controlStyles[78].styles[0]": "Margin=-5,0,0,0",
    "controlStyles[45].styles[2]": "Margin=-16,-23,0,7",
    "controlStyles[79].target": "JumpViewUI.ItemNotFoundFlyoutControl > StackPanel > StackPanel > TextBlock",
    "controlStyles[79].styles[0]": "FontFamily=$fontFamily",
    "controlStyles[80].target": "JumpViewUI.JumpListCategoryHeaderControl > Grid > TextBlock#HeadingTextBlock",
    "controlStyles[80].styles[0]": "Margin=15,9,0,5",
    "controlStyles[81].target": "MenuFlyoutSubItem > Grid@CommonStates",
    "controlStyles[81].styles[0]": "Background@SubMenuOpened:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[80].styles[1]": "FontFamily=$fontFamily",
    "controlStyles[32].styles[0]": "MinWidth=165",
    "controlStyles[70].styles[4]": "RadiusY=2",
    "controlStyles[81].styles[1]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[82].target": "Viewbox > Border > TextBlock",
    "controlStyles[82].styles[0]": "FontWeight=SemiBold",
    ...
    "controlStyles[83].target": "StartUI.AllAppsZoomListViewItem",
    "controlStyles[83].styles[0]": "CornerRadius=4",
    ...
    "controlStyles[82].styles[1]": "Margin=0,0,0,4",
    "controlStyles[84].target": "TextBlock#FolderDisplayName",
    "controlStyles[84].styles[0]": "Margin=9,0,0,5",
    ...
    "controlStyles[60].styles[0]": "FontFamily=$fontFamily",
    "controlStyles[64].styles[2]": "FontFamily=$fontFamily",
    "controlStyles[66].styles[2]": "FontFamily=$fontFamily",
    "controlStyles[68].styles[1]": "FontFamily=$fontFamily",
    "controlStyles[78].styles[1]": "FontFamily=$fontFamily",
    "controlStyles[82].styles[2]": "FontFamily=$fontFamily",
    ...
    "controlStyles[58].styles[1]": "MinHeight=30",
    "controlStyles[58].styles[2]": "Background@PointerOver:=$buttonNormal",
    "controlStyles[59].styles[1]": "Height=28",
    "controlStyles[81].styles[2]": "Padding=12,0,0,0",
    "controlStyles[59].styles[2]": "Background@PointerOver:=$buttonNormal",
    "controlStyles[85].target": "JumpViewUI.JumpListListViewItem > Grid@CommonStates",
    "controlStyles[85].styles[0]": "Background@PointerOver:=$buttonNormal",
    "controlStyles[86].target": "Button#PinButton",
    "controlStyles[86].styles[0]": "MinWidth=44",
    "controlStyles[87].target": "Button#PinButton > Grid > Border > ContentPresenter > TextBlock",
    "controlStyles[87].styles[0]": "Margin=3,0,0,0",
    "controlStyles[88].target": "FontIcon#SubItemChevron",
    "controlStyles[88].styles[0]": "Margin=-30,0,0,0",
    "controlStyles[81].styles[3]": "BorderBrush:=",
    "controlStyles[58].styles[3]": "Background@Pressed:=$buttonNormal",
    "controlStyles[7].styles[7]": "CornerRadius@Pressed=6",
    "controlStyles[89].target": "Border#SmallLogo",
    "controlStyles[89].styles[0]": "Margin=0,0,0,4",
    "controlStyles[90].styles[0]": "ChildTransitions:=<TransitionCollection><EntranceThemeTransition IsStaggeringEnabled=\"True\" FromHorizontalOffset=\"-37.5\" FromVerticalOffset=\"0\" /></TransitionCollection>",
    "controlStyles[90].target": "MenuFlyoutPresenter > Grid > ScrollViewer > Border",
    "controlStyles[91].target": "ToolTip > ContentPresenter#LayoutRoot > TextBlock",
    "controlStyles[91].styles[0]": "FontFamily=$fontFamily",
    "controlStyles[92].target": "StartUI.AllAppsGridListViewItem[AutomationProperties.AutomationId=RecentList] > StackPanel > Button > Border > TextBlock",
    "controlStyles[92].styles[0]": "Margin=15,0,0,2",
    ...
    "controlStyles[85].styles[1]": "Background@Pressed:=$buttonNormal",
    "controlStyles[59].styles[3]": "Background@Pressed:=$buttonNormal",
    "controlStyles[58].styles[4]": "BorderBrush:=",
    "controlStyles[93].target": "Button#ShutdownReasonButton",
    "controlStyles[93].styles[0]": "MinWidth=150",
    "controlStyles[93].styles[1]": "Height=32",
    "controlStyles[93].styles[2]": "CornerRadius=4",
    "controlStyles[94].target": "Button#ShutdownReasonButton > ContentPresenter@CommonStates",
    "controlStyles[94].styles[0]": "Background@Normal:=$buttonNormal",
    "controlStyles[94].styles[1]": "Background@PointerOver:=$buttonPointerOver",
    "controlStyles[94].styles[2]": "Background@Pressed:=$buttonPressed",
    "controlStyles[94].styles[3]": "BorderThickness=1",
    "controlStyles[94].styles[4]": "BorderBrush:=$buttonBorderBrush",
    "controlStyles[95].target": "ComboBox#ShutdownReasonComboBox",
    "controlStyles[95].styles[0]": "CornerRadius=4",
    "controlStyles[96].target": "ComboBox > Grid@CommonStates > Border#Background",
    "controlStyles[96].styles[0]": "Background@Normal:=$buttonNormal",
    "controlStyles[96].styles[1]": "CornerRadius=4",
    "controlStyles[96].styles[2]": "BorderThickness=1",
    "controlStyles[96].styles[3]": "BorderBrush:=$buttonBorderBrush",
    "controlStyles[96].styles[4]": "Background@PointerOver:=$buttonPointerOver",
    "controlStyles[96].styles[5]": "Background@Pressed:=$buttonPressed",
    "controlStyles[97].target": "ComboBoxItem",
    "controlStyles[97].styles[0]": "CornerRadius=4",
    "controlStyles[97].styles[1]": "Margin=3,0,3,0",
    "controlStyles[98].target": "ComboBoxItem > Grid@CommonStates",
    "controlStyles[98].styles[0]": "Background@PointerOver:=$buttonNormal",
    "controlStyles[98].styles[1]": "Background@Pressed:=$buttonNormal",
    "controlStyles[98].styles[2]": "Background@Selected:=$buttonNormal",
    "controlStyles[98].styles[3]": "Background@SelectedPressed:=$buttonNormal",
    "controlStyles[98].styles[4]": "Background@SelectedUnfocused:=$buttonNormal",
    "controlStyles[98].styles[5]": "Background@SelectedDisabled:=$buttonNormal",
    "controlStyles[98].styles[6]": "Background@SelectedPointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.48\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[99].target": "Border#PopupBorder",
    "controlStyles[99].styles[0]": "Background:=$background",
    "controlStyles[99].styles[1]": "CornerRadius=8",
    "controlStyles[100].target": "FlyoutPresenter",
    "controlStyles[100].styles[0]": "CornerRadius=8",
    "controlStyles[100].styles[1]": "Background:=$background",
    "controlStyles[100].styles[2]": "BorderBrush:=$borderBrush",
    "controlStyles[100].styles[3]": "Padding=16",
    "controlStyles[101].target": "StackPanel#ShutdownConfirmationFlyoutPanel",
    "controlStyles[101].styles[0]": "Margin=0,-1.5,0,0",
    "controlStyles[95].styles[1]": "MinWidth=166",
    "controlStyles[102].target": "StackPanel#ShutdownReasonFlyoutPanel",
    "controlStyles[102].styles[0]": "Margin=0,-3,0,0",
    ...
    "controlStyles[103].target": "Button#ShutdownConfirmationButton > ContentPresenter@CommonStates > TextBlock",
    ...
    "controlStyles[98].styles[7]": "BorderBrush:=",
    "controlStyles[104].target": "Button#ShutdownReasonButton > ContentPresenter@CommonStates > TextBlock",
    ...
    "controlStyles[105].target": "ComboBox > Grid@CommonStates > ContentPresenter > TextBlock",
    ...
    "controlStyles[106].target": "ComboBoxItem > Grid@CommonStates > ContentPresenter > TextBlock",
    ...
    "controlStyles[107].target": "StartUI.AllAppsGridListViewItem[AutomationProperties.AutomationId=FrequentList] > StackPanel > Button > Border > TextBlock",
    "controlStyles[107].styles[0]": "Margin=15,0,0,2",
    "controlStyles[108].target": "TextBlock#FolderGlyph",
    "controlStyles[108].styles[0]": "FontSize=9",
    "controlStyles[108].styles[1]": "FontWeight=Light",
    "controlStyles[88].styles[1]": "Glyph:=&#xE76C;",
    "controlStyles[109].target": "ItemsWrapGrid > StartUI.AllAppsZoomListViewItem > Windows.UI.Xaml.Controls.Primitives.ListViewItemPresenter > Border > TextBlock",
    "controlStyles[109].styles[0]": "FontWeight=Light",
    "controlStyles[109].styles[1]": "FontFamily=Segoe Fluent Icons",
    "controlStyles[78].styles[2]": "Foreground=White",
    "controlStyles[85].styles[2]": "BorderBrush:=",
    "controlStyles[110].target": "Grid#MainGrid@InteractionStates > Rectangle#BackgroundElement",
    "controlStyles[110].styles[0]": "Fill@InteractionState_Edit:=",
    "controlStyles[110].styles[1]": "Fill@InteractionState_Rest:=",
    "controlStyles[110].styles[2]": "Fill@InteractionState_Pressed:=",
    "controlStyles[110].styles[3]": "Fill@InteractionState_Drag:=",
    "controlStyles[110].styles[4]": "StrokeThickness=0",
    "controlStyles[111].target": "Border#NameTextBoxHost > TextBox > Grid > Border#BackgroundElement",
    "controlStyles[111].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeLowColor}\" TintOpacity=\"0.72\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeLowColor}\" />",
    "controlStyles[111].styles[1]": "CornerRadius=4",
    "controlStyles[111].styles[2]": "BorderThickness=0.5,0.5,0.5,0",
    "controlStyles[112].target": "Border#NameTextBoxHost > TextBox > Grid > Border#BorderElement",
    "controlStyles[112].styles[0]": "BorderThickness=0,0,0,1.5",
    "controlStyles[112].styles[1]": "CornerRadius=4",
    "controlStyles[112].styles[2]": "Height=28",
    "controlStyles[112].styles[3]": "BorderBrush:=$accentButtonNormal",
    "controlStyles[113].target": "Grid#MainGrid@FocusStates > Rectangle#BackgroundElement",
    "controlStyles[113].styles[0]": "Fill@FocusState_Hover:=$buttonNormal",
    "controlStyles[113].styles[1]": "Fill@FocusState_None=Transparent",
    "controlStyles[113].styles[2]": "StrokeThickness=0",
    "controlStyles[113].styles[3]": "Width=258",
    "controlStyles[113].styles[4]": "Height=28",
    "controlStyles[113].styles[5]": "Margin=0,0,50,0",
    "controlStyles[111].styles[3]": "BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.4\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[113].styles[6]": "Fill@FocusState_HoverPlaceholder:=$buttonNormal",
    "controlStyles[27].styles[5]": "CornerRadius=6",
    "controlStyles[27].styles[6]": "BorderThickness=0",
    "controlStyles[70].styles[5]": "Canvas.ZIndex=1",
    "controlStyles[70].styles[6]": "Fill@PointerOverSelected:=$accentButtonNormal",
    "controlStyles[52].styles[3]": "CornerRadius=8",
    "controlStyles[112].styles[4]": "Width=258",
    "controlStyles[51].styles[3]": "CornerRadius=8",
    "controlStyles[114].target": "Grid#MainGrid@FocusStates > Grid > Border#NameTextBlockHost",
    "controlStyles[114].styles[0]": "BorderThickness=0,0,0,1.5",
    "controlStyles[114].styles[1]": "BorderBrush@FocusState_Hover:=<SolidColorBrush Color=\"{ThemeResource SystemColorButtonFaceColor}\" Opacity=\"0.48\"/>",
    "controlStyles[114].styles[2]": "CornerRadius=4",
    "controlStyles[114].styles[3]": "Height=28",
    "controlStyles[114].styles[4]": "BorderBrush@FocusState_HoverPlaceholder:=<SolidColorBrush Color=\"{ThemeResource SystemColorButtonFaceColor}\" Opacity=\"0.48\"/>",
    "controlStyles[115].target": "StackPanel > Button#DeleteButton > Grid > ContentPresenter",
    "controlStyles[115].styles[0]": "BorderBrush:=",
    "controlStyles[35].styles[4]": "Margin=0,-1,0,0",
    "controlStyles[106].styles[5]": "Margin=0,1,0,-1",
    "controlStyles[31].styles[2]": "CornerRadius=0,4,4,0",
    "controlStyles[116].target": "FontIcon",
    "controlStyles[116].styles[0]": "FontFamily=Segoe Fluent Icons",
    "controlStyles[17].styles[0]": "Glyph:=&#xE73E;",
    "controlStyles[116].styles[1]": "Foreground=White",
    ...
    "controlStyles[117].target": "Grid#ContentRoot",
    "controlStyles[117].styles[0]": "BorderThickness=1,0,0,0",
    "controlStyles[117].styles[1]": "BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SystemColorButtonTextColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.4\" FallbackColor=\"#141414\" />",
    "controlStyles[58].styles[5]": "MinWidth=208",
    "controlStyles[117].styles[2]": "Margin=0,1,0,1",
    "controlStyles[118].target": "Border#NameTextBoxHost > TextBox",
    "controlStyles[118].styles[0]": "Margin=-2,0,0,0",
    "controlStyles[114].styles[5]": "Width=258",
    "controlStyles[114].styles[6]": "Margin=0,0,2,0",
    "controlStyles[119].target": "SplitView#RootContent",
    "controlStyles[119].styles[0]": "IsPaneOpen=False",
    "controlStyles[119].styles[1]": "OpenPaneLength=48",
    "controlStyles[120].target": "StartUI.NavigationPaneGrid > Border",
    "controlStyles[120].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeLowColor}\" TintOpacity=\"0.25\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeLowColor}\" />",
    "controlStyles[121].target": "StartUI.ExpandCollapseButton#NavigationPaneHamburgerButton",
    "controlStyles[121].styles[0]": "Visibility=Collapsed",
