...
```json
{
    ...
    "controlStyles[15].target": "JumpViewUI.JumpListListViewItem > Grid@CommonStates > ContentPresenter > JumpViewUI.JumpListItemControl > Grid#GridForContextMenuInvoke_MustHave_No_Columns_Or_Rows > Grid > TextBlock",
    ...
    "controlStyles[82].styles[0]": "CornerRadius=6",
    ...
    "controlStyles[86].target": "Button#PinButton > Grid@CommonStates > Border > ContentPresenter > TextBlock",
    ...
    "controlStyles[84].styles[1]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.64\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    ...
    "controlStyles[113].styles[1]": "BorderBrush@FocusState_Hover:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"#5B5B5B\" />",
    "controlStyles[113].styles[2]": "CornerRadius=4",
    "controlStyles[113].styles[3]": "Height=28",
    "controlStyles[113].styles[4]": "BorderBrush@FocusState_HoverPlaceholder:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"#5B5B5B\" />",
    ...
    "controlStyles[121].styles[0]": "CornerRadius=2",
    "controlStyles[121].styles[1]": "Margin=20,0,4,4",
    ...
    "controlStyles[123].target": "Border#NameTextBoxHost > TextBox > Grid > Button#DeleteButton > Grid@CommonStates > Border > TextBlock#GlyphElement",
    ...
    "controlStyles[127].target": "StartUI.UserTileView",
    "controlStyles[127].styles[0]": "Grid.Row=1",
    "controlStyles[128].target": "StartUI.ViewSelectionListView",
    "controlStyles[128].styles[0]": "Grid.Row=0",
    "controlStyles[129].target": "Border#HighlightBackground",
    "controlStyles[129].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.14\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[95].styles[6]": "Background@Selected=Red",
    "controlStyles[95].styles[7]": "Background@SelectedPointerOver=Yellow",
    "controlStyles[129].styles[1]": "Margin=-2",
    "controlStyles[129].styles[2]": "CornerRadius=6",
    "controlStyles[94].styles[2]": "FontFamily=$fontFamily",
    "controlStyles[129].styles[3]": "BorderBrush=White",
    "controlStyles[130].target": "Button#DeleteButton > Grid > Border",
    "controlStyles[130].styles[0]": "Background=Transparent",
    "controlStyles[123].styles[1]": "Opacity@Normal=1",
    "controlStyles[123].styles[2]": "Opacity@Pressed=0.84",
    ...
    "controlStyles[86].styles[1]": "Opacity@Normal=1",
    ...
    "controlStyles[132].styles[1]": "Background@Focused:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeLowColor}\" TintOpacity=\"0.72\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeLowColor}\" />",
    "controlStyles[132].styles[2]": "CornerRadius=4",
    "controlStyles[132].styles[3]": " BorderThickness=0.5,0.5,0.5,0",
    "controlStyles[132].styles[4]": "BorderBrush@Focused:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.4\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[132].styles[5]": "Height=28",
    "controlStyles[133].target": "StartUI.TileFolderNameTextBox > Grid@CommonStates",
    "controlStyles[133].styles[0]": "BorderThickness=0,0,0,1.5",
    "controlStyles[133].styles[1]": "BorderBrush@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"#5B5B5B\" />",
    "controlStyles[133].styles[2]": "BorderBrush@Focused:=$accentButtonNormal",
    "controlStyles[133].styles[3]": "CornerRadius=4",
    "controlStyles[133].styles[4]": "Height=28",
    "controlStyles[132].styles[6]": "Margin@PointerOver=-1",
    "controlStyles[132].styles[7]": "Margin@Focused=0",
    "controlStyles[134].target": "StartUI.TileFolderNameTextBox > Grid@CommonStates > Border > ScrollViewer",
    "controlStyles[134].styles[0]": "Margin=3,-4,0,0",
    "controlStyles[124].styles[1]": "Margin=5,0,0,1",
    "controlStyles[135].target": "Border#DeleteButtonWrapper > Button#DeleteButton > Grid@CommonStates",
    "controlStyles[135].styles[0]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[135].styles[1]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.48\" FallbackColor=\"{ThemeResource SystemChromeMediumColor}\" />",
    "controlStyles[135].styles[2]": "CornerRadius=4",
    "controlStyles[135].styles[3]": "Width=28",
    "controlStyles[135].styles[4]": "Height=20",
    "controlStyles[135].styles[5]": "Margin=-10,1,0,0",
    "controlStyles[136].target": "Border#DeleteButtonWrapper > Button#DeleteButton > Grid@CommonStates > Border > TextBlock#GlyphElement",
    "controlStyles[136].styles[0]": "Foreground=White",
    "controlStyles[136].styles[1]": "Opacity@Normal=1",
    "controlStyles[136].styles[2]": "Opacity@Pressed=0.84",
    ...
    "controlStyles[137].target": "Windows.UI.Xaml.Controls.Primitives.RepeatButton#VerticalSmallIncrease > Grid",
    "controlStyles[137].styles[0]": "Background=Transparent",
    "controlStyles[138].target": "Windows.UI.Xaml.Controls.Primitives.RepeatButton#VerticalSmallDecrease > Grid",
    "controlStyles[138].styles[0]": "Background=Transparent",
    ...
    "controlStyles[139].target": "StartUI.TileFolderNameTextBox > Grid@CommonStates > Border > TextBlock#PlaceholderTextContentPresenter",
    "controlStyles[139].styles[0]": "Margin=2,-4,0,0",
    "controlStyles[139].styles[1]": "Opacity@Normal=0",
