...
```json
{
    ...
    "controlStyles[20].target": "FlyoutPresenter",
    ...
    "controlStyles[21].target": "FlyoutPresenter > Grid > ContentPresenter > StartUI.UninstallFlyoutControl > StackPanel > TextBlock",
    ...
    "controlStyles[21].styles[3]": "Margin=13,13,0,0",
    "controlStyles[22].target": "FlyoutPresenter > Grid > ContentPresenter > StartUI.UninstallFlyoutControl > StackPanel > Button#UninstallButton > Grid#RootGrid@CommonStates",
    ...
    "controlStyles[23].target": "FlyoutPresenter > Grid > ContentPresenter > StartUI.UninstallFlyoutControl > StackPanel > Button#UninstallButton > Grid#RootGrid > ContentPresenter#ContentPresenter > TextBlock",
    ...
    "controlStyles[22].styles[5]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorLight2}\" TintOpacity=\"0.96\" TintLuminosityOpacity=\"0.96\"  FallbackColor=\"{ThemeResource SystemAccentColorLight2}\" />",
    ...
    "controlStyles[38].target": "StackPanel > Button#DeleteButton > Grid#RootGrid@CommonStates",
    ...
    "controlStyles[38].styles[3]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[39].target": "StackPanel > Button#DeleteButton > Grid#RootGrid > ContentPresenter#ContentPresenter > TextBlock",
    ...
    "controlStyles[40].styles[3]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemAccentColorLight2}\" TintOpacity=\"0.96\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemAccentColorLight2}\" />",
    "controlStyles[41].target": "StackPanel > Button#CancelButton > Grid#RootGrid > ContentPresenter#ContentPresenter > TextBlock",
    ...
    "controlStyles[58].styles[0]": "Margin=0,15,13,0",
    ...
    "controlStyles[65].target": "FlyoutPresenter > Border",
    "controlStyles[65].styles[0]": "Width=352",
    "controlStyles[45].styles[2]": "Margin=3,0,3,0",
    "controlStyles[46].styles[2]": "Margin=3,0,3,0",
    "controlStyles[65].styles[1]": "Height=120",
    "controlStyles[65].styles[2]": "CornerRadius=6",
    "controlStyles[65].styles[3]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumColor}\" TintOpacity=\"0.25\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumColor}\" />",
    "controlStyles[65].styles[4]": "BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0.4\" TintLuminosityOpacity=\"0.4\" FallbackColor=\"#424242\" />",
    "controlStyles[66].target": "TextBlock#ShutdownConfirmationTextBlock",
    "controlStyles[66].styles[0]": "Margin=0,3,0,0",
    "controlStyles[67].target": "Button#ShutdownConfirmationButton",
    "controlStyles[67].styles[0]": "Margin=0,17,0,0",
    "controlStyles[67].styles[1]": "Width=150",
    "controlStyles[67].styles[2]": "Height=32",
    "controlStyles[67].styles[3]": "CornerRadius=4",
    "controlStyles[68].target": "Button#ShutdownConfirmationButton > ContentPresenter#ContentPresenter@CommonStates",
    "controlStyles[68].styles[0]": "Background@Normal:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[68].styles[1]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[68].styles[2]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[68].styles[3]": "BorderThickness=1",
    "controlStyles[68].styles[4]": "BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[3].styles[2]": "Margin=0,0,-16,0",
    "controlStyles[69].target": "Border#NameTextBoxHost > TextBox > Grid > Button#DeleteButton > Grid@CommonStates",
    "controlStyles[69].styles[0]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.25\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\" />",
    "controlStyles[69].styles[1]": "CornerRadius=4",
    "controlStyles[69].styles[2]": "Height=20",
    "controlStyles[69].styles[3]": "Width=28",
    "controlStyles[69].styles[4]": "Margin=-10,0,0,0",
    "controlStyles[70].target": "Border#NameTextBoxHost > TextBox > Grid > Border#BorderElement",
    "controlStyles[70].styles[0]": "BorderThickness=0,0,0,1.5",
    "controlStyles[70].styles[1]": "CornerRadius=4",
    "controlStyles[70].styles[2]": "Width=256",
    "controlStyles[70].styles[3]": "Height=28",
    "controlStyles[70].styles[4]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" />",
    "controlStyles[71].target": "Border#NameTextBoxHost > TextBox",
    "controlStyles[71].styles[0]": "FontWeight=Semibold",
    "controlStyles[71].styles[1]": "FontSize=14",
    "controlStyles[71].styles[2]": "RequestedTheme=2",
    ...
    "controlStyles[72].target": "Grid#InnerRoot",
    "controlStyles[72].styles[0]": "Height=46",
    "controlStyles[73].target": "MenuFlyoutItem[5] > Grid",
    "controlStyles[73].styles[0]": "Height=46",
    "controlStyles[42].styles[2]": "Margin=1,0,0,2",
    "controlStyles[43].styles[1]": "Margin=8,-1,0,1",
    "controlStyles[74].target": "TextBlock#SignedInStatus",
    "controlStyles[74].styles[0]": "FontSize=12",
    "controlStyles[74].styles[1]": "Margin=8,-1,0,3",
    "controlStyles[75].target": "MenuFlyoutSeparator > Rectangle",
    "controlStyles[75].styles[0]": "Fill:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumHighColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumHighColor}\"/>",
    "controlStyles[76].target": "TextBlock#ExpandCollapseButtonText",
    "controlStyles[76].styles[0]": "Margin=20,0,0,0",
    "controlStyles[75].styles[1]": "Margin=0,4,0,3",
    ...
    "controlStyles[77].target": "MenuFlyoutItem[AutomationProperties.AutomationId=Review] > Grid",
    "controlStyles[77].styles[0]": "Height=28",
    "controlStyles[78].target": "Rectangle",
    "controlStyles[78].styles[0]": "RadiusX=4",
    "controlStyles[78].styles[1]": "RadiusY=4",
    ...
    "controlStyles[79].target": "Grid#RootPanel@CommonStates > Rectangle",
    "controlStyles[79].styles[0]": "Fill@Selected:=<SolidColorBrush Color=\"{ThemeResource SystemAccentColorLight2}\" />",
    "controlStyles[79].styles[1]": "Height=16",
    "controlStyles[79].styles[2]": "Width=3",
    "controlStyles[79].styles[3]": "RadiusX=2",
    ...
    "controlStyles[80].target": "StartUI.NavigationPaneGrid#RootPanel > StartUI.ExpandCollapseButton",
    "controlStyles[80].styles[0]": "Margin=5,5,4,4",
    "controlStyles[80].styles[1]": "Height=38",
    "controlStyles[81].target": "StartUI.NavigationPaneGrid#RootPanel > StartUI.UserTileView > StartUI.NavigationPaneButton#UserTileButton ",
    "controlStyles[81].styles[0]": "Margin=5",
    "controlStyles[81].styles[1]": "Height=36",
    "controlStyles[82].target": "StartUI.NavigationPaneGrid#RootPanel > StartUI.PowerOptionsView > StartUI.NavigationPaneButton#PowerButton ",
    "controlStyles[82].styles[0]": "Margin=5",
    "controlStyles[82].styles[1]": "Height=36",
    "controlStyles[83].target": "StartUI.ViewSelectionListViewItem",
    "controlStyles[83].styles[0]": "Margin=5",
    "controlStyles[83].styles[1]": "Height=36",
    "controlStyles[84].target": "StartUI.AppListViewItem",
    "controlStyles[84].styles[0]": "Margin=5",
    "controlStyles[84].styles[1]": "Height=36",
    "controlStyles[85].target": "StartUI.NavigationPaneItemPanel > FontIcon",
    "controlStyles[85].styles[0]": "Margin=-10,0,0,0",
    "controlStyles[86].target": "StartUI.NavigationPaneItemPanel > Grid > FontIcon",
    "controlStyles[86].styles[0]": "Margin=-12,0,0,0",
    "controlStyles[87].target": "StartUI.NavigationPaneButton#UserTileButton > ContentPresenter > StartUI.NavigationPaneItemPanel > Grid",
    ...
    "controlStyles[88].target": "StartUI.ExpandCollapseButton > ContentPresenter > StartUI.NavigationPaneItemPanel > TextBlock",
    "controlStyles[88].styles[0]": "Text=ModernStartMenu",
    "controlStyles[88].styles[1]": "FontWeight=SemiBold",
    "controlStyles[89].target": "StartUI.NavigationPaneItemPanel > TextBlock",
    "controlStyles[89].styles[0]": "Margin=-5,0,0,0",
    "controlStyles[88].styles[2]": "Padding=0,0,0,2",
    "controlStyles[90].target": "Grid#MainGrid@FocusStates > Rectangle#BackgroundElement",
    "controlStyles[90].styles[0]": "Fill@FocusState_Hover:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[90].styles[1]": "Fill@FocusState_None=Transparent",
    "controlStyles[90].styles[2]": "StrokeThickness=0",
    "controlStyles[49].styles[2]": "Margin=-8,0,0,0",
    "controlStyles[91].target": "JumpViewUI.ItemNotFoundFlyoutControl > StackPanel > StackPanel > TextBlock",
    "controlStyles[91].styles[0]": "FontFamily=Segoe UI Variable",
    "controlStyles[92].target": "JumpViewUI.JumpListCategoryHeaderControl > Grid > TextBlock#HeadingTextBlock",
    "controlStyles[92].styles[0]": "Margin=15,9,0,5",
    "controlStyles[93].target": "MenuFlyoutSubItem > Grid@CommonStates",
    "controlStyles[93].styles[0]": "Background@SubMenuOpened:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[92].styles[1]": "FontFamily=Segoe UI Variable",
    "controlStyles[36].styles[0]": "MinWidth=214",
    "controlStyles[79].styles[4]": "RadiusY=2",
    "controlStyles[93].styles[1]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[94].target": "Viewbox > Border > TextBlock",
    "controlStyles[94].styles[0]": "FontWeight=SemiBold",
    ...
    "controlStyles[95].target": "StartUI.AllAppsZoomListViewItem",
    "controlStyles[95].styles[0]": "CornerRadius=6",
    "controlStyles[96].target": "MenuFlyoutItem[6] > Grid",
    "controlStyles[97].target": "MenuFlyoutItem[7] > Grid",
    "controlStyles[98].target": "MenuFlyoutItem[8] > Grid",
    "controlStyles[99].target": "MenuFlyoutItem[AutomationProperties.AutomationId=disconnectNetworkDrive] > Grid",
    ...
    "controlStyles[94].styles[1]": "Margin=0,0,0,4",
    "controlStyles[100].target": "TextBlock#FolderDisplayName",
    "controlStyles[100].styles[0]": "Margin=9,0,0,7",
    "controlStyles[100].styles[1]": "FontFamily=Segoe UI Variable",
    ...
    "controlStyles[66].styles[1]": "FontFamily=Segoe UI Variable",
    "controlStyles[71].styles[3]": "FontFamily=Segoe UI Variable",
    "controlStyles[74].styles[2]": "FontFamily=Segoe UI Variable",
    "controlStyles[76].styles[1]": "FontFamily=Segoe UI Variable",
    "controlStyles[88].styles[3]": "FontFamily=Segoe UI Variable",
    "controlStyles[89].styles[1]": "FontFamily=Segoe UI Variable",
    "controlStyles[94].styles[2]": "FontFamily=Segoe UI Variable",
    ...
    "controlStyles[93].styles[2]": "Height=28",
    "controlStyles[93].styles[3]": "Padding=12,0,0,0",
    ...
    "controlStyles[101].target": "JumpViewUI.JumpListListViewItem > Grid@CommonStates",
    "controlStyles[101].styles[0]": "Background@PointerOver:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
    "controlStyles[102].target": "Button#PinButton",
    "controlStyles[102].styles[0]": "Width=44",
    "controlStyles[103].target": "Button#PinButton > Grid > Border > ContentPresenter > TextBlock",
    "controlStyles[103].styles[0]": "Margin=3,0,0,0",
    "controlStyles[104].target": "FontIcon#SubItemChevron",
    "controlStyles[104].styles[0]": "Margin=-30,0,0,0",
    "controlStyles[105].target": "MenuFlyoutItem[AutomationProperties.AutomationId=Share] > Grid",
    "controlStyles[105].styles[0]": "Height=28",
    "controlStyles[93].styles[4]": "BorderBrush:=",
    ...
    "controlStyles[107].styles[0]": "ChildTransitions:=<TransitionCollection><EntranceThemeTransition IsStaggeringEnabled=\"True\" FromHorizontalOffset=\"0\" FromVerticalOffset=\"75\" /></TransitionCollection>",
    ...
    "controlStyles[109].target": "ToolTip > ContentPresenter#LayoutRoot > TextBlock",
    "controlStyles[109].styles[0]": "FontFamily=Segoe UI Variable",
    ...
    "controlStyles[101].styles[1]": "Background@Pressed:=<AcrylicBrush TintColor=\"{ThemeResource SystemChromeMediumLowColor}\" TintOpacity=\"0\" TintLuminosityOpacity=\"0.96\" FallbackColor=\"{ThemeResource SystemChromeMediumLowColor}\" />",
