...
```json
{
  ...
  "controlStyles[7].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\".45\" TintLuminosityOpacity=\".96\" Opacity=\"1\"/>",
  ...
  "controlStyles[13].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\".25\" TintLuminosityOpacity=\".96\" Opacity=\"1\"/>",
  ...
  "controlStyles[17].styles[1]": "FontSize=16",
  "controlStyles[17].styles[2]": "Opacity=.85",
  ...
  "controlStyles[19].styles[5]": "Transform3D:=<CompositeTransform3D TranslateX=\"2\" />",
  ...
  "controlStyles[21].target": "Grid#TopLevelRoot",
  "controlStyles[21].styles[0]": "Margin=0,-8,0,0",
  "controlStyles[22].target": "GridViewItem",
  "controlStyles[22].styles[0]": "Height=96",
  "controlStyles[22].styles[1]": "Margin=0,0,0,2",
  ...
  "controlStyles[30].styles[0]": "Margin=0,31,0,-62",
  ...
  "controlStyles[31].styles[2]": "Margin=4,0,0,0",
  ...
  "controlStyles[45].target": "Border#LogoBackgroundPlate",
  "controlStyles[45].styles[0]": "Margin=12,0,0,0",
  "controlStyles[46].target": "Grid#WebViewGrid",
  "controlStyles[46].styles[0]": "Margin=-13,0,-10,15",
  "controlStyles[47].target": "Border#DropShadow",
  "controlStyles[47].styles[0]": "CornerRadius=12",
  "controlStyles[48].target": "Windows.UI.Xaml.Controls.FlyoutPresenter[1]",
  "controlStyles[48].styles[0]": "Margin=-250,50,0,0",
  "controlStyles[49].target": "StartDocked.LauncherFrame > Grid#RootGrid > Grid#RootContent > Grid#MainContent > Grid#InnerContent > Rectangle",
  "controlStyles[49].styles[0]": "Visibility=1",
  "controlStyles[50].target": "Windows.UI.Xaml.Controls.FlyoutPresenter",
  "controlStyles[50].styles[0]": "Margin=-250,0,0,0",
  "controlStyles[51].target": "StartMenu.ExpandedFolderList > Grid#Root > Border",
  "controlStyles[51].styles[0]": "Height=420",
  "controlStyles[52].target": "TextBox#ExpandedFolderNameTextBox",
  "controlStyles[52].styles[0]": "Margin=-15,-15,15,20",
  "controlStyles[53].target": "Windows.UI.Xaml.Controls.GridView#FolderList > Border",
  "controlStyles[53].styles[0]": "Margin=0,0,0,-60",
  "controlStyles[54].target": "StartDocked.NavigationPaneView#NavigationPane > Grid > StartDocked.AppListView",
  "controlStyles[54].styles[0]": "Margin=0,0,-306,0",
  ...
  "controlStyles[11].styles[3]": "FontWeight=600",
  "controlStyles[55].target": "Image#SearchIconOn",
  "controlStyles[55].styles[0]": "Visibility=1",
  "controlStyles[56].target": "Image#SearchIconOff",
  "controlStyles[56].styles[0]": "Visibility=1",
  "controlStyles[11].styles[4]": "Transform3D:=<CompositeTransform3D TranslateX=\"-3\" />",
  "controlStyles[11].styles[5]": "FontSize=16",
  "controlStyles[17].styles[3]": "Transform3D:=<CompositeTransform3D TranslateX=\"-32\" />",
  "controlStyles[9].styles[1]": "Margin=0,8,0,0",
  "controlStyles[17].styles[4]": "FontWeight=600",
  "controlStyles[26].styles[2]": "FontWeight=500",
  "controlStyles[27].styles[2]": "FontWeight=500",
  "controlStyles[34].styles[4]": "Margin=0,0,0,-2",
  "controlStyles[14].styles[1]": "Margin=-1",
  "controlStyles[47].styles[1]": "Margin=-1",
  "controlStyles[57].target": "TextBlock#StatusMessage",
  "controlStyles[57].styles[0]": "Transform3D:=<CompositeTransform3D TranslateX=\"4\"/>",
  "controlStyles[57].styles[1]": "FontWeight=500",
  "controlStyles[57].styles[2]": "FontFamily=Aptos",
  "controlStyles[31].styles[3]": "FontWeight=500",
  "controlStyles[58].target": "StartDocked.AppListView#NavigationPanePlacesListView",
  "controlStyles[58].styles[0]": "Transform3D:=<CompositeTransform3D TranslateX=\"0\" TranslateY=\"-645\"/>",
  "controlStyles[59].target": "Grid#ContentBorder > Border#BackgroundBorder",
  "controlStyles[59].styles[0]": "CornerRadius=99",
  "controlStyles[58].styles[1]": "Margin=0,0,57,0",
  "controlStyles[60].target": "Grid#ContentBorder > ContentPresenter > FontIcon",
  "controlStyles[60].styles[0]": "Margin=6,0,0,0",
  "controlStyles[59].styles[1]": "Height=38",
  "controlStyles[59].styles[2]": "Width=38",
  "controlStyles[61].target": "StartDocked.AppListView#NavigationPanePlacesListView > Border > ScrollViewer > Border#Root > Grid > ScrollContentPresenter > ItemsPresenter > ItemsStackPanel",
  "controlStyles[61].styles[0]": "HorizontalAlignment=2",
  "controlStyles[58].styles[2]": "Padding=0,0,6,0",
  "controlStyles[62].target": "StartDocked.AppListView#NavigationPanePlacesListView > Border > ScrollViewer > Border#Root > Grid > ScrollContentPresenter > ItemsPresenter > ItemsStackPanel > ListViewItem",
  "controlStyles[62].styles[0]": "Margin=-1"
}
```
</details>
