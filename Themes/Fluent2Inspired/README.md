...
```json
{
  ...
  "controlStyles[7].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource ControlFillColorInputActive}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\".45\" TintLuminosityOpacity=\".96\" Opacity=\"1\"/>",
  ...
  "controlStyles[13].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource ControlFillColorInputActive}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\".25\" TintLuminosityOpacity=\".96\" Opacity=\"1\"/>",
