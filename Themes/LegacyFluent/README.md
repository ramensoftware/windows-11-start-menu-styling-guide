...
```json
{
  ...
  "controlStyles[1].target": "Windows.UI.Xaml.Controls.GridView#PinnedList > Border > ScrollViewer > Border > Grid > ScrollContentPresenter > ItemsPresenter > ItemsWrapGrid > Windows.UI.Xaml.Controls.GridViewItem",
  "controlStyles[1].styles[0]": "Width=100",
  "controlStyles[1].styles[2]": "Margin=2",
  "controlStyles[1].styles[1]": "Height=100",
  "controlStyles[2].target": "Windows.UI.Xaml.Controls.GridView#PinnedList > Border > ScrollViewer > Border > Grid > ScrollContentPresenter > ItemsPresenter > ItemsWrapGrid",
  ...
  "controlStyles[5].styles[0]": "Height=518",
  "controlStyles[6].target": "Windows.UI.Xaml.Controls.Grid#ShowMoreSuggestions > Windows.UI.Xaml.Controls.Button > Windows.UI.Xaml.Controls.ContentPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[6].styles[0]": "Text=Recommended",
  "controlStyles[7].target": "StartMenu.PinnedListTile > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Grid#DisplayNameAndDownloadIconContainer > Windows.UI.Xaml.Controls.TextBlock#DisplayName",
  "controlStyles[7].styles[0]": "Margin=4,0,0,2",
  "controlStyles[7].styles[1]": "TextAlignment=1",
  "controlStyles[8].target": "StartMenu.PinnedListTile > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Grid#DisplayNameAndDownloadIconContainer",
  "controlStyles[8].styles[0]": "HorizontalAlignment=1",
  "controlStyles[8].styles[1]": "Width=95",
  "controlStyles[8].styles[2]": "Margin=0",
  "controlStyles[8].styles[3]": "VerticalAlignment=2",
  "controlStyles[9].target": "StartMenu.PinnedListTile > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Grid#LogoContainer",
  "controlStyles[9].styles[0]": "Margin=0,17,0,0",
  "controlStyles[10].target": "Windows.UI.Xaml.Controls.Grid#DroppedFlickerWorkaroundWrapper > Windows.UI.Xaml.Controls.ContentPresenter#ContentPresenter > Windows.UI.Xaml.Controls.Grid",
  "controlStyles[10].styles[0]": "Height=95",
  "controlStyles[10].styles[1]": "Width=100",
  "controlStyles[11].target": "Windows.UI.Xaml.Controls.TextBlock#PinnedListHeaderText",
  "controlStyles[11].styles[0]": "Text=PINNED",
  "controlStyles[11].styles[1]": "FontWeight=Bold",
  "controlStyles[12].target": "StartDocked.AppListView#NavigationPanePlacesListView > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.ScrollViewer > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.ScrollContentPresenter > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.ItemsStackPanel > StartDocked.AppListViewItem > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[12].styles[0]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[12].styles[1]": "BorderThickness=1",
  "controlStyles[12].styles[2]": "CornerRadius=0",
  "controlStyles[12].styles[3]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[12].styles[4]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[12].styles[5]": "BorderBrush:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[13].target": "Windows.UI.Xaml.Controls.Border#AcrylicBorder",
  "controlStyles[13].styles[0]": "CornerRadius=0",
  ...
  "controlStyles[15].target": "Grid#FrameRoot",
  "controlStyles[15].styles[0]": "Margin=-13,0,0,-13",
  "controlStyles[16].target": "StartDocked.NavigationPaneButton#PowerButton > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[16].styles[0]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[16].styles[1]": "BorderThickness=1",
  "controlStyles[16].styles[2]": "CornerRadius=0",
  "controlStyles[16].styles[3]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[16].styles[4]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[16].styles[5]": "BorderBrush:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[17].target": "StartDocked.NavigationPaneButton#UserTileButton > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border",
  ...
  "controlStyles[18].target": "StartMenu.SearchBoxToggleButton > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[18].styles[0]": "CornerRadius=0",
  "controlStyles[18].styles[1]": "Background:=<SolidColorBrush Color=\"{ThemeResource SystemChromeLowColor}\" Opacity=\"0.5\"/>",
  "controlStyles[18].styles[2]": "BorderThickness=2",
  "controlStyles[18].styles[3]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource SystemListMediumColor}\"/>",
  "controlStyles[18].styles[4]": "BorderBrush@PointerOver:=<SolidColorBrush Color=\"{ThemeResource SystemChromeHighColor}\"/>",
  "controlStyles[18].styles[5]": "BorderBrush@CheckedPointerOver:=<SolidColorBrush Color=\"{ThemeResource SystemChromeHighColor}\"/>",
  "controlStyles[19].target": "Windows.UI.Xaml.Controls.Image#SearchIconOn",
  "controlStyles[19].styles[0]": "Visibility=Collapsed",
  "controlStyles[20].target": "Windows.UI.Xaml.Controls.Image#SearchIconOff",
  "controlStyles[20].styles[0]": "Visibility=Collapsed",
  "controlStyles[21].target": "Windows.UI.Xaml.Controls.FontIcon#SearchGlyph",
  "controlStyles[21].styles[0]": "Visibility=Visible",
  "controlStyles[22].target": "Windows.UI.Xaml.Controls.TextBlock#PlaceholderText",
  "controlStyles[22].styles[0]": "Text=Type here to search",
  "controlStyles[23].target": "Windows.UI.Xaml.Controls.Button > Windows.UI.Xaml.Controls.ContentPresenter@CommonStates",
  "controlStyles[23].styles[0]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[23].styles[1]": "BorderThickness=1",
  "controlStyles[23].styles[2]": "CornerRadius=0",
  "controlStyles[23].styles[3]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[23].styles[4]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[23].styles[5]": "BorderBrush:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[23].styles[6]": "Background=Transparent",
  "controlStyles[23].styles[7]": "Height=30",
  "controlStyles[24].target": "StartDocked.AllAppsGridListViewItem > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.Button#Header > Windows.UI.Xaml.Controls.Border@CommonStates",
  ...
  "controlStyles[24].styles[5]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[24].styles[6]": "Background=Transparent",
  "controlStyles[24].styles[7]": "BorderBrush@Pressed:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[25].target": "StartDocked.AllAppsGridListViewItem > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border#BorderBackground",
  "controlStyles[25].styles[0]": "BorderThickness=1",
  "controlStyles[25].styles[1]": "CornerRadius=0",
  "controlStyles[25].styles[2]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[25].styles[3]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[25].styles[4]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[25].styles[5]": "Background=Transparent",
  "controlStyles[25].styles[6]": "BorderBrush@Pressed:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[26].target": "Windows.UI.Xaml.Controls.TextBlock#AllAppsHeading",
  "controlStyles[26].styles[0]": "Text=ALL",
  "controlStyles[26].styles[1]": "FontWeight=Bold",
  "controlStyles[27].target": "Windows.UI.Xaml.Controls.TextBlock#StatusMessage[Text=System]",
  "controlStyles[27].styles[0]": "Visibility=Collapsed",
  "controlStyles[28].target": "Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.Grid#VerticalRoot > Windows.UI.Xaml.Controls.Primitives.Thumb > Windows.UI.Xaml.Shapes.Rectangle#ThumbVisual",
  "controlStyles[28].styles[0]": "RadiusX=0",
  "controlStyles[28].styles[1]": "RadiusY=0",
  "controlStyles[28].styles[2]": "Margin=0,0,0,0",
  "controlStyles[29].target": "Windows.UI.Xaml.Shapes.Rectangle#VerticalTrackRect",
  "controlStyles[29].styles[0]": "RadiusX=0",
  "controlStyles[29].styles[1]": "RadiusY=0",
  "controlStyles[30].target": "Windows.UI.Xaml.Controls.Primitives.RepeatButton#VerticalSmallIncrease > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.FontIcon#Arrow > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[30].styles[0]": "Text=",
  "controlStyles[31].target": "Windows.UI.Xaml.Controls.Primitives.RepeatButton#VerticalSmallDecrease > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.FontIcon#Arrow > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[31].styles[0]": "Text=",
  "controlStyles[32].target": "StartDocked.AllAppsZoomListViewItem > Windows.UI.Xaml.Controls.Grid#ContentBorder@CommonStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[32].styles[0]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[32].styles[1]": "BorderThickness=1",
  "controlStyles[32].styles[2]": "CornerRadius=0",
  "controlStyles[32].styles[3]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[32].styles[4]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[32].styles[5]": "BorderBrush@Pressed:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[32].styles[6]": "Background=Transparent",
  "controlStyles[32].styles[7]": "BorderBrush:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[32].styles[8]": "BorderThickness@PointerOver=2",
  "controlStyles[32].styles[9]": "BorderThickness@Pressed=2",
  "controlStyles[33].target": "StartDocked.AllAppsZoomListViewItem > Windows.UI.Xaml.Controls.Grid#ContentBorder@DisabledStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[33].styles[0]": "RenderTransform@Disabled:=<ScaleTransform ScaleX=\"0\" ScaleY=\"0\" CenterX=\"0.5\" CenterY=\"0.5\" />",
  "controlStyles[34].target": "Windows.UI.Xaml.Controls.Border#LayerBorder",
  "controlStyles[34].styles[0]": "Visibility=Collapsed",
  "controlStyles[35].target": "Cortana.UI.Views.TaskbarSearchPage",
  "controlStyles[35].styles[0]": "RenderTransform:=<TranslateTransform X=\"-13\" Y=\"1\" />",
  "controlStyles[36].target": "Windows.UI.Xaml.Controls.Border#TaskbarMargin",
  "controlStyles[36].styles[0]": "Visibility=Collapsed",
  "controlStyles[37].target": "Windows.UI.Xaml.Controls.Border#AppBorder",
  "controlStyles[37].styles[0]": "CornerRadius=0",
  "controlStyles[37].styles[1]": "BorderThickness=0",
  "controlStyles[38].target": "Windows.UI.Xaml.Controls.Border#StartDropShadow",
  "controlStyles[38].styles[0]": "CornerRadius=0",
  "controlStyles[39].target": "Windows.UI.Xaml.Controls.Grid#RootGrid@SearchBoxInputStates > Windows.UI.Xaml.Controls.Border#TaskbarSearchBackground",
  "controlStyles[39].styles[0]": "CornerRadius=0",
  "controlStyles[39].styles[1]": "Background:=<SolidColorBrush Color=\"{ThemeResource SystemChromeLowColor}\" Opacity=\"0.5\"/>",
  "controlStyles[39].styles[2]": "BorderThickness=2",
  "controlStyles[39].styles[3]": "BorderBrush:=<SolidColorBrush Color=\"{ThemeResource SystemListMediumColor}\"/>",
  "controlStyles[39].styles[4]": "BorderBrush@SearchBoxHover:=<SolidColorBrush Color=\"{ThemeResource SystemChromeHighColor}\"/>",
  "controlStyles[39].styles[5]": "BorderBrush@FindInStartSearchBoxHover:=<SolidColorBrush Color=\"{ThemeResource SystemChromeHighColor}\"/>",
  "controlStyles[39].styles[6]": "Margin=25,37,21,15",
  "controlStyles[40].target": "Windows.UI.Xaml.Controls.Button#SearchGlyphContainer",
  "controlStyles[40].styles[0]": "Visibility=Visible",
  ...
  "controlStyles[42].target": "Windows.UI.Xaml.Controls.TextBlock#MoreSuggestionsListHeaderText",
  "controlStyles[42].styles[0]": "Text=RECOMMENDED",
  "controlStyles[42].styles[1]": "FontWeight=Bold",
  "controlStyles[43].target": "Windows.UI.Xaml.Controls.ListView#RecommendedList > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.ScrollViewer > Windows.UI.Xaml.Controls.Border > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.ScrollContentPresenter > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.ItemsStackPanel > Windows.UI.Xaml.Controls.ListViewItem > Windows.UI.Xaml.Controls.Grid@CommonStates > Windows.UI.Xaml.Controls.Border",
  "controlStyles[43].styles[0]": "BorderThickness=1",
  "controlStyles[43].styles[1]": "CornerRadius=0",
  "controlStyles[43].styles[2]": "Background@PointerOver:=<RevealBorderBrush Color=\"{ThemeResource SystemListLowColor}\" TargetTheme=\"1\" Opacity=\"0.5\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[43].styles[3]": "Background@Pressed:=<RevealBorderBrush Color=\"{ThemeResource SystemChromeHighColor}\" TargetTheme=\"1\" Opacity=\"0.6\" FallbackColor=\"{ThemeResource SystemListLowColor}\"/>",
  "controlStyles[43].styles[4]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[43].styles[5]": "Background=Transparent",
  "controlStyles[43].styles[6]": "BorderBrush@Pressed:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\" />",
  "controlStyles[44].target": "Windows.UI.Xaml.Controls.ToolTip",
  "controlStyles[44].styles[0]": "CornerRadius=0",
  ...
  "controlStyles[46].target": "Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[46].styles[0]": "FontFamily=Segoe UI, Segoe MDL2 Assets",
  "controlStyles[47].target": "Windows.UI.Xaml.Controls.FontIcon > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[47].styles[0]": "FontFamily=Segoe MDL2 Assets, Segoe UI",
  "controlStyles[48].target": "Windows.UI.Xaml.Controls.MenuFlyoutItem",
  "controlStyles[48].styles[0]": "CornerRadius=0",
  "controlStyles[49].target": "Windows.UI.Xaml.Controls.ListViewItem",
  "controlStyles[49].styles[0]": "CornerRadius=0",
  "controlStyles[50].target": "Windows.UI.Xaml.Controls.Button#HideMoreSuggestionsButton > Windows.UI.Xaml.Controls.ContentPresenter#ContentPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.FontIcon > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[50].styles[0]": "FontSize=10",
  "controlStyles[51].target": "Windows.UI.Xaml.Controls.Grid#ShowMoreSuggestions",
  "controlStyles[51].styles[0]": "RenderTransform:=<TranslateTransform X=\"-18.5\" Y=\"-586\"/>",
  "controlStyles[52].target": "Windows.UI.Xaml.Controls.Button#ShowMoreSuggestionsButton > Grid > Windows.UI.Xaml.Controls.ContentPresenter > Windows.UI.Xaml.Controls.StackPanel > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[52].styles[0]": "Text=Recommended",
  "controlStyles[53].target": "Grid#TopLevelHeader > Grid > Button",
  "controlStyles[53].styles[0]": "Visibility=Collapsed",
  "controlStyles[54].target": "Border#dropshadow",
  "controlStyles[54].styles[0]": "CornerRadius=0",
  "controlStyles[55].target": "Grid#MainMenu",
  "controlStyles[55].styles[0]": "Width=650",
  "controlStyles[56].target": "Grid#FrameRoot",
  "controlStyles[56].styles[0]": "Height=750",
  "controlStyles[57].target": "Windows.UI.Xaml.Controls.GridViewItem",
  "controlStyles[57].styles[0]": "Margin=2",
  "controlStyles[58].target": "Windows.UI.Xaml.Controls.GridView#RecommendedList",
  "controlStyles[58].styles[0]": "Visibility=Collapsed",
  "controlStyles[59].target": "Grid#TopLevelSuggestionsRoot",
  "controlStyles[59].styles[0]": "Margin=0,0,0,-190",
  ...
  "controlStyles[62].target": "Microsoft.UI.Xaml.Controls.DropDownButton",
  "controlStyles[63].target": "Microsoft.UI.Xaml.Controls.DropDownButton > Grid#RootGrid",
  "controlStyles[62].styles[0]": "Background:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.3\"/>",
  "controlStyles[63].styles[0]": "CornerRadius=0",
  "controlStyles[63].styles[1]": "Background:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.6\"/>",
  "controlStyles[63].styles[2]": "BorderBrush:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.7\"/>",
  "controlStyles[45].styles[1]": "Background:=<AcrylicBrush TintColor=\"#22848484\" TintOpacity=\"0.2\" Opacity=\"1\"/>",
  "controlStyles[45].styles[2]": "BorderBrush:=<AcrylicBrush TintColor=\"#22848484\" TintOpacity=\"0.2\" Opacity=\"1\"/>",
  "controlStyles[45].styles[3]": "BorderThickness=1",
  "controlStyles[64].target": "Windows.UI.Xaml.Controls.GridViewItem > Windows.UI.Xaml.Controls.Border#ContentBorder@CommonStates > Windows.UI.Xaml.Controls.Grid#DroppedFlickerWorkaroundWrapper > Windows.UI.Xaml.Controls.Border#BackgroundBorder",
  "controlStyles[64].styles[0]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\"/>",
  "controlStyles[64].styles[1]": "BorderThickness=1",
  "controlStyles[64].styles[2]": "CornerRadius=0",
  "controlStyles[64].styles[3]": "Margin=0",
  "controlStyles[11].styles[2]": "Margin=78,-4,0,4",
  "controlStyles[64].styles[4]": "Background@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.7\"/>",
  "controlStyles[65].target": "Button#Header",
  "controlStyles[65].styles[0]": "Style:=",
  "controlStyles[66].target": "Windows.UI.Xaml.Controls.ListView#ZoomedOutListView",
  "controlStyles[66].styles[0]": "Margin=0,-150,0,0",
  "controlStyles[67].target": "Windows.UI.Xaml.Controls.ListViewItem > Grid#ContentBorder@CommonStates > Border",
  "controlStyles[67].styles[0]": "Background@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.7\"/>",
  "controlStyles[67].styles[1]": "BorderBrush@PointerOver:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"1\"/>",
  "controlStyles[67].styles[2]": "Background@Pressed:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.7\"/>",
  "controlStyles[67].styles[3]": "Background@Pressed=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.7\"/>",
  "controlStyles[65].styles[1]": "Height=40"
}
```
</details>
