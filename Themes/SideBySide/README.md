...
```json
{
  ...
  "controlStyles[9].styles[1]": "RenderTransform:=<TranslateTransform X=\"-145\" Y=\"800\"/>",
  ...
  "controlStyles[12].styles[0]": "Margin=-60,355,60,-355",
  ...
  "controlStyles[18].styles[2]": "MinHeight=129",
  "controlStyles[18].styles[3]": "BorderThickness=0,1,0,0",
  "controlStyles[18].styles[4]": "BorderBrush=#22BBBBBB",
  ...
  "controlStyles[21].styles[0]": "Margin=485,360,0,0",
...
```json
{
  ...
  "controlStyles[4].styles[0]": "Width=860",
  ...
  "controlStyles[6].styles[0]": "Margin=-22,-5,0,0",
  "controlStyles[7].target": "Grid#TopLevelSuggestionsListHeader",
  "controlStyles[7].styles[0]": "Margin=45,-15,0,0",
  "controlStyles[8].target": "StartDocked.AllAppsGridListView > Windows.UI.Xaml.Controls.ScrollViewer > Border > Grid > Windows.UI.Xaml.Controls.Primitives.ScrollBar",
  "controlStyles[8].styles[0]": "Margin=-8,0,8,2",
  "controlStyles[9].target": "Microsoft.UI.Xaml.Controls.PipsPager#PinnedListPipsPager",
  "controlStyles[9].styles[0]": "Margin=-8,0,8,0",
  "controlStyles[10].target": "Windows.UI.Xaml.Controls.ItemsWrapGrid > Windows.UI.Xaml.Controls.GridViewItem",
  "controlStyles[10].styles[0]": "MaxWidth=185",
  "controlStyles[10].styles[1]": "MinWidth=85",
  "controlStyles[11].target": "StartMenu.PinnedList#StartMenuPinnedList",
  "controlStyles[11].styles[0]": "Margin=-15,0,5,0",
  "controlStyles[12].target": "Grid#ShowMoreSuggestions",
  "controlStyles[12].styles[0]": "Margin=0,20,0,-20",
  "controlStyles[13].target": "Grid#MoreSuggestionsRoot",
  "controlStyles[13].styles[0]": "Margin=-1,0,-4,-30",
  "controlStyles[14].target": "Windows.UI.Xaml.Controls.TextBlock#MoreSuggestionsListHeaderText",
  "controlStyles[14].styles[0]": "Margin=-40,0,0,0",
  "controlStyles[15].target": "Button#ShowMoreSuggestionsButton",
  "controlStyles[15].styles[0]": "Margin=0,-58,25,0",
  "controlStyles[16].target": "Grid#TopLevelSuggestionsContainer",
  "controlStyles[16].styles[0]": "Margin=30,-10,30,-60",
  "controlStyles[17].target": "Windows.UI.Xaml.Controls.GridViewItem",
  "controlStyles[17].styles[0]": "Margin=0",
  "controlStyles[18].target": "Border#AcrylicOverlay",
  "controlStyles[18].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\"0.1\" TintLuminosityOpacity=\"1\" Opacity=\"1\"/>",
  "controlStyles[19].target": "Windows.UI.Xaml.Controls.SemanticZoom#ZoomControl",
  "controlStyles[19].styles[0]": "IsZoomOutButtonEnabled=true",
  "controlStyles[20].target": "Windows.UI.Xaml.Controls.Button#ZoomOutButton > Windows.UI.Xaml.Controls.ContentPresenter#ContentPresenter > Windows.UI.Xaml.Controls.TextBlock",
  "controlStyles[20].styles[0]": "Text=",
  "controlStyles[21].target": "Windows.UI.Xaml.Controls.Button#ZoomOutButton",
  "controlStyles[21].styles[0]": "Width=24",
  "controlStyles[21].styles[1]": "Height=24",
  "controlStyles[21].styles[2]": "FontSize=14",
  "controlStyles[21].styles[3]": "CornerRadius=4",
  "controlStyles[21].styles[4]": "VerticalAlignment=0",
  "controlStyles[21].styles[5]": "Margin=-8,-35,8,0",
  "controlStyles[22].target": "Border#LayerBorder",
  "controlStyles[22].styles[0]": "Background:=<AcrylicBrush TintColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" FallbackColor=\"{ThemeResource CardStrokeColorDefaultSolid}\" TintOpacity=\"0.1\" TintLuminosityOpacity=\"1\" Opacity=\"1\"/>"
}
```
</details>
