...
```json
{
 ...
 "controlStyles[0].target":"Border#AcrylicBorder",
  ...
  "controlStyles[12].target":"StartMenu.PinnedList#StartMenuPinnedList > Grid#Root > GridView#PinnedList > Border",
    "controlStyles[12].styles[0]":"Padding=0,10,0,10",
  ...
  "controlStyles[25].target":"Grid#TopLevelHeader > Grid > Button",
    "controlStyles[25].styles[0]":"Visibility=1",
    "controlStyles[25].styles[1]":"// Not Sure Which Button I hid here ",
  ...
  "controlStyles[41].target":"Grid#AllListHeading > Microsoft.UI.Xaml.Controls.DropDownButton#ViewSelectionButton > Grid#RootGrid",
    ...
    "controlStyles[41].styles[1]":"// All Apps Heading Grid > View type button",
  ...
  "controlStyles[57].target":"TextBlock#PinnedListHeaderText",
    ...
    "controlStyles[57].styles[2]":"Margin=60,-5,0,0",
...
- *If you use the [LayerMicaUI]() Taskbar Styler Theme, this change is recommended.*
