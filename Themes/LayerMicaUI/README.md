...
- Alternate minimal variant available
...
## Manual installation - Normal Theme
...
```json
{
    ...
    "controlStyles[8].styles[0]":"BorderThickness=0,1,1,0",
...
## Alternate Minimal Theme
![Left](screenshot-preview-minimal.png)

- This is a minimal variant of the same theme.
- Theme can be selected directly from the mod settings.


## Manual installation - Alternate Minimal Theme
...
```json
{
    ...
    "disableNewStartMenuLayout":0,
    "controlStyles[0].target":"StartMenu.StartHome",
    "controlStyles[0].styles[0]":"Width=440",
    "controlStyles[0].styles[1]":"Margin=-30,10,-3,-50",
    "controlStyles[1].target":"Windows.UI.Xaml.Controls.Grid#SuggestionsParentContainer",
    "controlStyles[1].styles[0]":"Visibility=Collapsed",
    "controlStyles[2].target":"StartDocked.PowerOptionsView",
    "controlStyles[2].styles[0]":"Margin=0,-1255,-35,0",
    "controlStyles[3].target":"StartMenu.SearchBoxToggleButton#SearchBoxToggleButton",
    "controlStyles[3].styles[0]":"Height=42",
    "controlStyles[3].styles[1]":"Margin=-18,-3,75,-10",
    "controlStyles[4].target":"StartMenu.PinnedList#StartMenuPinnedList",
    "controlStyles[4].styles[0]":"Margin=5,0,-20,0",
    "controlStyles[4].styles[1]":"Height=Auto",
    "controlStyles[4].styles[2]":"MinHeight:=200",
    "controlStyles[4].styles[3]":"MaxHeight:=1000",
    "controlStyles[4].styles[4]":"Width=450",
    ...
    "controlStyles[6].styles[2]":"Width=420",
    "controlStyles[7].target":"Border#AcrylicOverlay",
    "controlStyles[7].styles[0]":"Margin=0,5,0,-65",
    "controlStyles[7].styles[1]":"CornerRadius=3,3,10,10",
    "controlStyles[8].target":"StartDocked.PowerOptionsView > StartDocked.NavigationPaneButton > Grid > Border",
    "controlStyles[8].styles[0]":"CornerRadius=0,8,8,0",
    "controlStyles[8].styles[1]":"Margin=-1",
    "controlStyles[8].styles[2]":"BorderThickness=1",
    "controlStyles[8].styles[3]":"Background:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\" Opacity=\"0.6\"/>",
    "controlStyles[8].styles[4]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"1\"/>",
    "controlStyles[9].target":"StartDocked.UserTileView",
    "controlStyles[9].styles[0]":"Margin=258,-1255,-27,0",
    "controlStyles[10].target":"StartDocked.UserTileView > StartDocked.NavigationPaneButton > Grid > Border",
    "controlStyles[10].styles[0]":"Margin=5,-1,15,-1",
    "controlStyles[10].styles[1]":"CornerRadius=0",
    "controlStyles[10].styles[2]":"Background:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\" Opacity=\"0.8\"/>",
    "controlStyles[10].styles[3]":"BorderThickness=0,1,0,1",
    "controlStyles[10].styles[4]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"1\"/>",
    "controlStyles[11].target":"StartMenu.SearchBoxToggleButton#SearchBoxToggleButton > Grid > Border",
    "controlStyles[11].styles[0]":"Background:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\" Opacity=\"0.8\"/>",
    "controlStyles[11].styles[1]":"CornerRadius=8,0,0,8",
    "controlStyles[11].styles[2]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"1\"/>",
    "controlStyles[12].target":"Windows.UI.Xaml.Controls.Border#ContentBorder > Windows.UI.Xaml.Controls.Grid#DroppedFlickerWorkaroundWrapper > Border@CommonStates",
    "controlStyles[12].styles[0]":"Margin=1",
    "controlStyles[13].target":"Border#TaskbarSearchBackground",
    "controlStyles[13].styles[0]":"CornerRadius=8",
    "controlStyles[13].styles[1]":"Background:=<SolidColorBrush Color=\"{ThemeResource ControlFillColorSecondary}\" Opacity=\"1\"/>",
    "controlStyles[13].styles[2]":"BorderThickness=1",
    "controlStyles[13].styles[3]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"1\"/>",
    "controlStyles[14].target":"Cortana.UI.Views.RichSearchBoxControl#SearchBoxControl > Grid#RootGrid",
    "controlStyles[14].styles[0]":"CornerRadius=8",
    "controlStyles[15].target":"Windows.UI.Xaml.Controls.Grid#SearchBoxOnTaskbarGleamContainer",
    "controlStyles[15].styles[0]":"CornerRadius=6",
    "controlStyles[16].target":"Windows.UI.Xaml.Controls.Grid#SearchBoxOnTaskbarGleamImageContainer",
    "controlStyles[16].styles[0]":"CornerRadius=6",
    "controlStyles[17].target":"StartMenu.FolderModal#StartFolderModal > Grid#Root > Border",
    "controlStyles[17].styles[0]":"BorderThickness=2",
    "controlStyles[17].styles[1]":"Width=340",
    "controlStyles[17].styles[2]":"Height=350",
    "controlStyles[17].styles[3]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"1\"/>",
    "controlStyles[17].styles[4]":"Margin=30,0,0,0",
    "controlStyles[18].target":"Windows.UI.Xaml.Controls.Grid#GridViewContainer",
    "controlStyles[18].styles[0]":"Width=360",
    "controlStyles[18].styles[1]":"Margin=30,0,-4,0",
    ...
    "controlStyles[20].target":"Windows.UI.Xaml.Controls.TextBlock#ZoomedOutHeading",
    "controlStyles[20].styles[0]":"Visibility=1",
    "controlStyles[21].target":"Windows.UI.Xaml.Controls.Grid#FrameRoot",
    "controlStyles[21].styles[0]":"Height=auto",
    "controlStyles[21].styles[1]":"MinHeight=648",
    "controlStyles[21].styles[2]":"MaxHeight=720",
    "controlStyles[22].target":"Windows.UI.Xaml.Controls.Grid#MainMenu",
    "controlStyles[22].styles[0]":"Width=420",
    "controlStyles[23].target":"Windows.UI.Xaml.Controls.Border#StartDropShadow",
    "controlStyles[23].styles[0]":"Width=420",
    "controlStyles[24].target":"Windows.UI.Xaml.Controls.Grid#TopLevelHeader > Windows.UI.Xaml.Controls.Grid > Windows.UI.Xaml.Controls.Button",
    "controlStyles[24].styles[0]":"Visibility=1",
    "controlStyles[25].target":"StartMenu.PinnedList#StartMenuPinnedList > Windows.UI.Xaml.Controls.Grid#Root > Windows.UI.Xaml.Controls.GridView#PinnedList > Windows.UI.Xaml.Controls.Border",
    "controlStyles[25].styles[0]":"BorderBrush:=<AcrylicBrush TintColor=\"{ThemeResource SurfaceStrokeColorDefault}\" FallbackColor=\"{ThemeResource SurfaceStrokeColorDefault}\" TintOpacity=\".2\" TintLuminosityOpacity=\".3\" Opacity=\"0.7\"/>",
    "controlStyles[25].styles[1]":"BorderThickness=0,0,0,1",
    "controlStyles[25].styles[2]":"CornerRadius=0",
    "controlStyles[25].styles[3]":"Padding=0,0,0,20",
    "controlStyles[26].target":"Microsoft.UI.Xaml.Controls.PipsPager#PipsPager",
    "controlStyles[26].styles[0]":"Margin=-30,-10,0,10",
    "webContentCustomJs":""
}
```
</details>
...
- **Issue-1:** The user tile and power button may be displaced or incorrectly sized.
