...
#Collapsed Elements    
  ...
  - target: Grid#TopLevelHeader > Grid[2]
    styles:
      - Visibility=Collapsed      
  - target: Grid#TopLevelHeader > Grid > TextBlock#AllListHeadingText
    styles:
      - Visibility=Collapsed
...
#Pinned List    
  - target: Windows.UI.Xaml.Controls.GridView#PinnedList > Border > Windows.UI.Xaml.Controls.ScrollViewer > Border > Grid > Windows.UI.Xaml.Controls.ScrollContentPresenter > Windows.UI.Xaml.Controls.ItemsPresenter > Windows.UI.Xaml.Controls.ItemsWrapGrid > Windows.UI.Xaml.Controls.GridViewItem > Border#ContentBorder@CommonStates > Grid#DroppedFlickerWorkaroundWrapper > Border[1]
    styles:
      ...
      - Background:=<SolidColorBrush Color="{ThemeResource SystemBaseMediumColor}" Opacity="0.14"/>

#Pinned List Scroll Mode (allows scrolling, otherwise fixed height)    
  - target: ScrollViewer
    styles:
...
#Grouped Apps Modal     
  - target: Windows.UI.Xaml.Controls.GridView#LevelOneGridView
    styles:
      - Width=295
      - RenderTransform:=<TranslateTransform Y="-10" />
  - target: Microsoft.UI.Xaml.Controls.PipsPager
    styles:
      - RenderTransform:=<TranslateTransform X="-55" Y="-15"/>
  - target: StartMenu.FolderModal
    styles:
      - RenderTransform:=<TranslateTransform X="158" />
...
#Power Button    
  - target: StartDocked.PowerOptionsView
    styles:
      - Transform3D:=<CompositeTransform3D TranslateY="-560" TranslateX="517" RotationZ="90" />
      - Margin=-650,600,650,-600
      - Canvas.ZIndex=99
...
#Grid View
  - target: Grid#PageRoot@ViewStates > SemanticZoom#TopLevelRoot > Grid > ScrollViewer#ScrollViewer > ScrollContentPresenter#ScrollContentPresenter > Grid > ContentPresenter#ZoomedInPresenter > GridView#AllAppsGrid > Border > Grid#SideBySidePinnedWrapper > ScrollViewer#ScrollViewer > Border#Root > Grid > ScrollContentPresenter#ScrollContentPresenter > ItemsPresenter
    styles:      
      - Margin@Alpha_GridView=28,0,0,0
...
#User Account Flyout
  - target: FlyoutPresenter
    styles:
      - RenderTransform:=<TranslateTransform X="-64" Y="92" />    
...
#Phone Panel Flyout    
  ...
  - target: ListViewItem > Grid#ContentBorder@CommonStates
    styles:
      ...
      - CornerRadius=5
      - Background:=<RevealBorderBrush Color="Transparent" TargetTheme="1" Opacity="0"/>
  #Flyout Button Force Clickable
  - target: Grid#MainMenu > Grid#MainContent > Grid
    styles:
      - Canvas.ZIndex=1

#Search Menu 
  - target: Cortana.UI.Views.TaskbarSearchPage > Grid
    styles:
      - Height=720
      - RenderTransform:=<TranslateTransform Y="110" />  
  ...
  - target: Cortana.UI.Views.TaskbarSearchPage > Grid#RootGrid@SearchBoxLocationStates > Border#TaskbarSearchBackground
    styles:
      ...
      - BorderThickness=1
      - MaxWidth=692
      - RenderTransform:=<TranslateTransform X="-30" />
      - RenderTransform@SearchBoxOnTop:=<TranslateTransform X="-30" />
      - RenderTransform@SearchBoxOnBottomWithoutQFMargin:=<TranslateTransform X="0" Y="-1"/>
      - Margin@SearchBoxOnBottomWithoutQFMargin=Auto    
