...
"controlStyles[15].target": "Border#ContentBorder > Grid#DroppedFlickerWorkaroundWrapper > Border#BackgroundBorder",
"controlStyles[15].styles[0]": "Background:=<RevealBorderBrush Color=\"Transparent\" TargetTheme=\"1\" Opacity=\"0.3\" />",
"controlStyles[15].styles[1]": "BorderBrush:=$Reveal",
"controlStyles[15].styles[2]": "BorderThickness=2",
"controlStyles[15].styles[3]": "CornerRadius=12",
"controlStyles[15].styles[4]": "Height=70",
"controlStyles[15].styles[5]": "Width=70",
"controlStyles[15].styles[6]": "//Target= Start Menu > Hover-Over Box For Pinned items (Apps & Folders)",
...
"controlStyles[17].target": "Image#Logo",
"controlStyles[17].styles[0]": "Height=40",
"controlStyles[17].styles[1]": "Width=40",
"controlStyles[17].styles[2]": "//Target= Start Menu > Pinned App Icon",
...
"controlStyles[21].target": "TextBlock#DisplayName",
"controlStyles[21].styles[0]": "Visibility=Collapsed",
"controlStyles[21].styles[1]": "//Target= Start Menu > Name of Pinned Apps & Folders",

"controlStyles[22].target": "Grid#SuggestionsParentContainer",
"controlStyles[22].styles[0]": "Visibility=Collapsed",
"controlStyles[22].styles[1]": "//Target= Start Menu > Suggestions Section",

"controlStyles[23].target": "Grid#TopLevelSuggestionsListHeader",
"controlStyles[23].styles[0]": "Visibility=Collapsed",
"controlStyles[23].styles[1]": "//Target= Start Menu > Suggestions Text \"Recomended\"",

"controlStyles[24].target": "Grid#ShowMoreSuggestions",
"controlStyles[24].styles[0]": "Visibility=Collapsed",
"controlStyles[24].styles[1]": "//Target= Start Menu > Show More Suggestions Button",

"controlStyles[25].target": "Grid#TopLevelSuggestionsContainer",
"controlStyles[25].styles[0]": "Visibility=Collapsed",
"controlStyles[25].styles[1]": "//Target= Start Menu > Suggestions Entries",

"controlStyles[26].target": "StartDocked.NavigationPaneButton#PowerButton > Grid",
"controlStyles[26].styles[0]": "BorderBrush:=$Reveal",
"controlStyles[26].styles[1]": "BorderThickness=2",
"controlStyles[26].styles[2]": "CornerRadius=12",
"controlStyles[26].styles[3]": "//Target= Start Menu > Power Button",

"controlStyles[27].target": "StartDocked.NavigationPaneButton#PowerButton > Grid > ContentPresenter > Grid > FontIcon",
"controlStyles[27].styles[0]": "Foreground:=$SolidAccent",
"controlStyles[27].styles[1]": "//Target= Start Menu > Power Button icon",

"controlStyles[28].target": "FontIcon#WindowsUpdatePendingReminder",
"controlStyles[28].styles[0]": "Foreground:=$SolidAccent",
"controlStyles[28].styles[1]": "//Target= Start Menu > Power Button > Update Reminder (Default:#ff9900)",

"controlStyles[29].target": "FontIcon#IconOverlay",
"controlStyles[29].styles[0]": "Foreground:=$SolidAccent",
"controlStyles[29].styles[1]": "//Target= Start Menu > Power Button > Context Menu > Update Reminder (Default:#ff9900)",

"controlStyles[30].target": "Border#BackgroundBorder",
"controlStyles[30].styles[0]": "CornerRadius=12",
"controlStyles[30].styles[1]": "//Target= Start Menu > Hover-Over Box For Buttons (Power Button, Libraries & User Button)",

"controlStyles[31].target": "Button#ShowAllAppsButton > ContentPresenter",
...
"controlStyles[31].styles[3]": "//Target= Start Menu > \"All >\" Button",

"controlStyles[32].target": "Button#CloseAllAppsButton > ContentPresenter",
...
"controlStyles[32].styles[3]": "//Target= Start Menu > All Apps Page > \"< Back\" Button",

"controlStyles[33].target": "Button > ContentPresenter > StackPanel > TextBlock",
"controlStyles[33].styles[0]": "Visibility=Collapsed",
"controlStyles[33].styles[1]": "//Target= Start Menu > \"All >\" & \"< Back\" Buttons Text",

"controlStyles[34].target": "StackPanel > FontIcon > Grid > TextBlock",
"controlStyles[34].styles[0]": "FontSize=14 //(Default=10)",
"controlStyles[34].styles[1]": "//Target= Start Menu > \"All >\" & \"< Back\" Buttons Arrows Text",

"controlStyles[35].target": "Windows.UI.Xaml.Controls.TextBlock#AllAppsHeading",
"controlStyles[35].styles[0]": "Visibility=Collapsed",
"controlStyles[35].styles[1]": "//Target= Start Menu > All Apps Page > \"All\" Text",

"controlStyles[36].target": "StartDocked.AllAppsZoomListViewItem > Grid#ContentBorder@DisabledStates > Border#BorderBackground",
"controlStyles[36].styles[0]": "BorderBrush@Enabled:=$Reveal",
"controlStyles[36].styles[1]": "//Target= Start Menu > All Apps Page > Alphabet Zoomed-Out Buttons",

"controlStyles[37].target": "Border#Border",
"controlStyles[37].styles[0]": "BorderBrush:=$Reveal",
"controlStyles[37].styles[1]": "BorderThickness=2",
"controlStyles[37].styles[2]": "CornerRadius=12",
"controlStyles[37].styles[3]": "//Target= Start Menu > All Apps Page > Hover-Over Box for Alphabet",

"controlStyles[38].target": "Border#BorderBackground",
"controlStyles[38].styles[0]": "CornerRadius=12",
"controlStyles[38].styles[1]": "//Target= Start Menu > All Apps Page > Hover-Over Box for Apps & Folders",

"controlStyles[39].target": "Border#AppBorder",
"controlStyles[39].styles[0]": "Background:=$Alt",
"controlStyles[39].styles[1]": "BorderBrush=Transparent",
"controlStyles[39].styles[2]": "CornerRadius=20",
"controlStyles[39].styles[3]": "//Target= Search Menu's Body",

"controlStyles[40].target": "Border#LayerBorder",
"controlStyles[40].styles[0]": "Visibility=Collapsed",
"controlStyles[40].styles[1]": "//Target= Search Menu > Acrylic Overlay Layer for Search Menu",

"controlStyles[41].target": "Border#dropshadow",
"controlStyles[41].styles[0]": "Visibility=Collapsed",
"controlStyles[41].styles[1]": "//Target= Search Menu > Drop Shadow",

"controlStyles[42].target": "Border#TaskbarSearchBackground",
"controlStyles[42].styles[0]": "Background=Transparent",
"controlStyles[42].styles[1]": "BorderBrush=Transparent",
"controlStyles[42].styles[2]": "//Target= Search Menu > Search Box Overlay",

"controlStyles[43].target": "Cortana.UI.Views.RichSearchBoxControl#SearchBoxControl > Grid#RootGrid",
"controlStyles[43].styles[0]": "BorderBrush:=$Reveal",
"controlStyles[43].styles[1]": "BorderThickness=2",
"controlStyles[43].styles[2]": "CornerRadius=20",
"controlStyles[43].styles[3]": "//Target= Search Menu > Seach Box",

"controlStyles[44].target": "Microsoft.UI.Xaml.Controls.AnimatedIcon#SearchIconPlayer",
"controlStyles[44].styles[0]": "Width=20",
"controlStyles[44].styles[1]": "//Target= Search Menu > Search icon",
